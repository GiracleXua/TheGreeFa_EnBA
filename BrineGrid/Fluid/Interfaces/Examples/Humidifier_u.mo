...
model Humidifier_u
 ...
 parameter Modelica.SIunits.MassFlowRate mWat_flow_nominal = 0.001
  ...
  BrineGrid.Fluid.Sources.Boundary_pT sin_1(
    redeclare package Medium = Medium,
    use_p_in=true,
    T=288.15,
...
protected
  model Humidifier
    ...
    extends BrineGrid.Fluid.MassExchangers.Humidifier_u;
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/Humidifier_u.mos"
        "Simulate and plot"),
