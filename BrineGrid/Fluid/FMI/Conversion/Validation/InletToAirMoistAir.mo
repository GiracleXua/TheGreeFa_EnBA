...
model InletToAirMoistAir
  "Validation model for inlet to BrineGrid.Media.Air conversion without trace substances"
  ...
  BrineGrid.Fluid.FMI.Conversion.InletToAir conAir(
  ...
  BrineGrid.Fluid.FMI.Conversion.InletToAir conAirRevFlo(redeclare package
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAir.mos"
        "Simulate and plot"),
