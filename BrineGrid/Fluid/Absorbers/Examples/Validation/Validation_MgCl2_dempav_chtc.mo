...
model Validation_MgCl2_dempav_chtc
  "set convective heat and mass transfer coefficient as input parameter instead of Nu and Sh"
...
end Validation_MgCl2_dempav_chtc;
