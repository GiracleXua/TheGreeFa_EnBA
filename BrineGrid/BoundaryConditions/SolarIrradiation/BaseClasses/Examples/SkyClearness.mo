...
model SkyClearness "Test model for sky clearness"
  ...
  BrineGrid.BoundaryConditions.WeatherData.Bus weaBus
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/SkyClearness.mos"
        "Simulate and plot"));
end SkyClearness;
