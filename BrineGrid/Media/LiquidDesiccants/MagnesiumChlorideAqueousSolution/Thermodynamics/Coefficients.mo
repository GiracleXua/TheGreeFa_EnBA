...
record Coefficients
  ...
  // MagnesiumChlorideAqueousSolutions

  // Density
  final constant Real[6] dw_coeff= {1.9937718430, 1.0985211604, -0.5094492996,
      -1.7619124270, -44.9005480267, -723692.2618632};

  // Specific enthalpy
  final constant Real[6] h_coeff = {-1.05252616e3,  3.75550823e0, -5.11934879e2,
      4.78672511e-4, -4.44122366e0,  8.36881428e2};

  // ###################old coefficient for LiBr####################
  ...
  // Saturated liquid water Wagner Prusss (1993)
  // Density
