...
model HydraulicDiameter
 ...
 package Medium = BrineGrid.Media.Air "Medium model";
  ...
  BrineGrid.Fluid.FixedResistances.HydraulicDiameter res(
    redeclare package Medium = Medium,
    length=10,
    m_flow_nominal=0.2,
    v_nominal=1,
    from_dp=true) "Fixed resistance with specified hydraulic diameter"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/HydraulicDiameter.mos"
        "Simulate and plot"),
