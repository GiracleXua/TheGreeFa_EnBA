within BrineGrid.Airflow.Multizone.BaseClasses;
partial model TwoWayFlowElement "Flow resistance that uses the power law"
  ...
  extends BrineGrid.Airflow.Multizone.BaseClasses.ErrorControl;
...
equation
  ...
  rho_a1_inflow = BrineGrid.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a1.p,
  ...
  rho_a2_inflow = BrineGrid.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a2.p,
