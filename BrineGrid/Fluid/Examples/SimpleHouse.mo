...
model SimpleHouse
  ...
  package MediumAir = BrineGrid.Media.Air;
  package MediumWater = BrineGrid.Media.Water;
...
It servers as a demonstration case of how the <code>BrineGrid</code> library can be used.
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Examples/SimpleHouse.mos"
        "Simulate and plot"));
end SimpleHouse;
