within BrineGrid.BoundaryConditions.SkyTemperature;
block BlackBody "Calculate black body sky temperature"
  extends Modelica.Blocks.Icons.Block;
  import BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation;
  parameter BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation calTSky=
...
equation
  if calTSky == BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation.TemperaturesAndSkyCover then
    TDewPoiK =  BrineGrid.Utilities.Math.Functions.smoothMin(TDryBul, TDewPoi, 0.1);
