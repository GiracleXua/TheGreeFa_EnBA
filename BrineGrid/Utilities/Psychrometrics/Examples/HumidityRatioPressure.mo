...
model HumidityRatioPressure "Unit test for humidity ratio model"
 ...
 package Medium = BrineGrid.Media.Air "Medium model"
  ...
  BrineGrid.Utilities.Psychrometrics.pW_X vapPre(
  ...
  Modelica.Blocks.Sources.Constant p(k=101325) "Pressure"
            ...
            {-60,40}})));
  BrineGrid.Utilities.Psychrometrics.X_pW humRat(
                            use_p_in=true)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/HumidityRatioPressure.mos"
        "Simulate and plot"));
