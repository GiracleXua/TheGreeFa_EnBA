...
model Inlet "Adaptor for connecting a fluid inlet to the FMI interface"
  ...
  BrineGrid.Fluid.FMI.Interfaces.Inlet inlet(
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b(
    redeclare final package Medium=Medium) "Fluid port"
        ...
        transformation(extent={{90,-10},{110,10}}), iconTransformation(extent={{90,-10},
            {110,10}})));
  BrineGrid.Fluid.FMI.Interfaces.PressureOutput p if use_p_in "Pressure"
  annotation (
      Placement(
      transformation(
        extent={{-10,-10},{10,10}},
...
BrineGrid.Fluid.FMI.OutletAdaptor</a> in order for
