...
model TraceSubstanceConservation
  ...
  package Medium = BrineGrid.Media.Air(extraPropertiesNames={substanceName});
  BrineGrid.Fluid.Sources.MassFlowSource_h sou(
  ...
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSubIn(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
    allowFlowReversal=false,
  ...
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSubOut(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
    allowFlowReversal=false,
