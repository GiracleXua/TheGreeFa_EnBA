...
model CheckPressure "Test model for pressure check"
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckPressure chePre
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckPressure.mos"
        "Simulate and plot"));
end CheckPressure;
