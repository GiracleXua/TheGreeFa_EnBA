within BrineGrid.Utilities.Math.Examples;
model IntegratorWithReset "Test model for integrator with reset"
  ...
  BrineGrid.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5, reset=BrineGrid.Types.Reset.Parameter,
    k=0.5,
    y_reset=2)                                      "Integrator with reset"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  BrineGrid.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  BrineGrid.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  BrineGrid.Utilities.Math.IntegratorWithReset intDef
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegratorWithReset.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BrineGrid.Utilities.Math.IntegratorWithReset\">
BrineGrid.Utilities.Math.IntegratorWithReset</a>
