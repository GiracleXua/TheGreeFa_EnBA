...
extends Modelica.Icons.Example;
 package Medium = BrineGrid.Media.Water "Medium model";
  BrineGrid.Fluid.Interfaces.ConservationEquation dyn(redeclare package Medium =
  ...
  BrineGrid.Fluid.Interfaces.StaticTwoPortConservationEquation ste(
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T bou(
    nPorts=2,
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ConservationEquation.mos"
        "Simulate and plot"),
