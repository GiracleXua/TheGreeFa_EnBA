...
model DoorDiscretizedOperable
  ...
  extends BrineGrid.Airflow.Multizone.BaseClasses.DoorDiscretized;
...
equation
  ...
  for i in 1:nCom loop
    dV_flow[i] = BrineGrid.Airflow.Multizone.BaseClasses.powerLaw(
      k=kVal,
      dp=dpAB[i],
      m=m,
...
if the door is open.
Use the model
<a href=\"modelica://BrineGrid.Airflow.Multizone.DoorDiscretizedOpen\">
BrineGrid.Airflow.Multizone.DoorDiscretizedOpen</a>
