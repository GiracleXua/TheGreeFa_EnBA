...
model LosslessPipe "Validation model for lossless pipe"
 ...
 package Medium = BrineGrid.Media.Air "Medium model";
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T sou(
    ...
    nPorts=1,
    use_m_flow_in=true,
    T=273.15 + 20) "Pressure boundary condition"
  ...
  BrineGrid.Fluid.FixedResistances.LosslessPipe res(
    redeclare package Medium = Medium,
    show_T=true,
    m_flow_nominal=1) "Fixed resistance"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/LosslessPipe.mos"
        "Simulate and plot"),
