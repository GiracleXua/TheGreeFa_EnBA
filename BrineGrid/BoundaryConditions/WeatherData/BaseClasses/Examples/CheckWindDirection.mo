...
model CheckWindDirection "Test model for wind direction check"
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckWindDirection
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckWindDirection.mos"
        "Simulate and plot"));
