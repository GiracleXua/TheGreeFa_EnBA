...
block X_pTphi
  ...
  extends
    BrineGrid.Utilities.Psychrometrics.BaseClasses.HumidityRatioVaporPressure;
...
algorithm
  pSat := BrineGrid.Media.Air.saturationPressure(T);
  X[i_w] := BrineGrid.Utilities.Psychrometrics.Functions.X_pSatpphi(
...
Set the medium model to <code>BrineGrid.Media.Air</code>.
