...
model Carnot_y "Test model for heat pump based on Carnot efficiency"
 ...
 package Medium2 = BrineGrid.Media.Water "Medium model";
  ...
  BrineGrid.Fluid.HeatPumps.Carnot_y heaPum(
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sin1(
    ...
    annotation (Placement(
        ...
        extent={{10,-10},{-10,10}},
        origin={50,40})));
  BrineGrid.Fluid.Sources.FixedBoundary sin2(
    nPorts=1,
    redeclare package Medium = Medium2)
    annotation (Placement(
        transformation(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/Carnot_y.mos"
        "Simulate and plot"),
