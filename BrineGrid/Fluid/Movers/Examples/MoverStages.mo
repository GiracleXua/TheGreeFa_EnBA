...
model MoverStages
  ...
  extends BrineGrid.Fluid.Movers.Examples.MoverParameter(
    pump_Nrpm(inputType=BrineGrid.Fluid.Types.InputType.Stages),
    pump_m_flow(inputType=BrineGrid.Fluid.Types.InputType.Stages),
    pump_y(inputType=BrineGrid.Fluid.Types.InputType.Stages),
    pump_dp(inputType=BrineGrid.Fluid.Types.InputType.Stages));
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Examples/MoverStages.mos"
        "Simulate and plot"),
