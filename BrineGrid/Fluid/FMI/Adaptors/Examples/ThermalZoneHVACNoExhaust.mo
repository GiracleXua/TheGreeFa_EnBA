...
model ThermalZoneHVACNoExhaust
  ...
  BrineGrid.Fluid.FMI.Adaptors.HVAC hvacAda(
  ...
  BrineGrid.Fluid.FMI.Adaptors.ThermalZone con(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/Adaptors/Examples/ThermalZoneHVACNoExhaust.mos"
        "Simulate and plot"),
