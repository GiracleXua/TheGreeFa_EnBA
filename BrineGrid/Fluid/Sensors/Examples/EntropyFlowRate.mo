...
model EntropyFlowRate "Test model for the entropy flow rate sensors"
  ...
  BrineGrid.Fluid.Sensors.EntropyFlowRate  senS_flow(
  ...
  BrineGrid.Fluid.Sensors.SpecificEntropyTwoPort  senS(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/EntropyFlowRate.mos"
