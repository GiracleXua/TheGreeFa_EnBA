...
model FlowControlled_m_flow
 ...
 extends BrineGrid.Fluid.Movers.Validation.BaseClasses.FlowMachine_ZeroFlow(
    ...
    redeclare BrineGrid.Fluid.Movers.FlowControlled_m_flow floMacSta(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      filteredSpeed=false,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    redeclare BrineGrid.Fluid.Movers.FlowControlled_m_flow floMacDyn(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      filteredSpeed=false,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/FlowControlled_m_flow.mos"
        "Simulate and plot"),
