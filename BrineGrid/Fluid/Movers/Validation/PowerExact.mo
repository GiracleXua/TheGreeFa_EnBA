...
model PowerExact
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/PowerExact.mos"
        "Simulate and plot"),
        Documentation(
info="<html>
<p>
...
BrineGrid.Fluid.Movers.Validation.PowerSimplified</a>, except that the
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/Movers/Validation/PowerExact.png\"/>
</p>
</html>",
revisions="<html>
<ul>
