...
model PowerSimplified
  ...
  BrineGrid.Fluid.Movers.SpeedControlled_Nrpm pump_Nrpm(
  ...
  BrineGrid.Fluid.Movers.FlowControlled_dp  pump_dp(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pump_m_flow(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    redeclare Data.Pumps.Wilo.Stratos30slash1to8 per(
      pressure(V_flow={0,0}, dp={0,0}),
...
equation
  ...
  annotation (    experiment(StopTime=200),
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/PowerSimplified.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/Movers/Validation/PowerSimplified.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
...
<code>expected subtype of record BrineGrid.Fluid.Movers.Data.Generic</code>.
</li>
<li>
