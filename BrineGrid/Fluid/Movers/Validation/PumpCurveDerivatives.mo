...
model PumpCurveDerivatives
  ...
  BrineGrid.Utilities.Diagnostics.AssertInequality assIne(threShold=1e-8)
    "Assertion check for positive derivatives"
    annotation (Placement(transformation(extent={{40,-20},{60,0}})));
  BrineGrid.Fluid.Sensors.RelativePressure relPre1(
  ...
  BrineGrid.Utilities.Diagnostics.AssertInequality assIne1(threShold=1e-8)
    "Assertion check for positive derivatives"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  BrineGrid.Utilities.Diagnostics.AssertInequality assIne2(threShold=1e-8)
    "Assertion check for positive derivatives"
...
equation
  ...
  annotation (__Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/PumpCurveDerivatives.mos"
        "Simulate and plot"),
