within BrineGrid.Fluid.HeatExchangers;
model HeaterCooler_T
  ...
  extends BrineGrid.Fluid.Interfaces.TwoPortFlowResistanceParameters(
    final computeFlowResistance=(abs(dp_nominal) > Modelica.Constants.eps));
  extends BrineGrid.Fluid.Interfaces.PrescribedOutletStateParameters(
...
protected
  BrineGrid.Fluid.FixedResistances.PressureDrop preDro(
  ...
  BrineGrid.Fluid.Interfaces.PrescribedOutletState heaCoo(
    redeclare final package Medium = Medium,
    final allowFlowReversal=allowFlowReversal,
...
BrineGrid.Fluid.HeatExchangers.HeaterCooler_u</a>
...
the examples
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_T\">
BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_T</a>
and
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_T_dynamic\">
BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_T_dynamic</a>.
</p>
</html>",
revisions="<html>
<ul>
