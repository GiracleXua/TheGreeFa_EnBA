...
model TwoWayTable "Two way valve with table-specified flow characteristics"
  ...
  // Since the flow model BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow computes
...
initial equation
  ...
  assert(BrineGrid.Utilities.Math.Functions.isMonotonic(
...
BrineGrid.Fluid.Actuators.Valves.TwoWayLinear</a> provides a more
