within BrineGrid.Airflow.Multizone.BaseClasses.Examples;
...
equation
  dp = 10*(-1+2*time);
  V_flow = BrineGrid.Airflow.Multizone.BaseClasses.powerLaw(
    dp=dp,
    k=k,
    m=m,
    dp_turbulent=dp_turbulent);
  VFixed_flow = BrineGrid.Airflow.Multizone.BaseClasses.powerLawFixedM(
    k=k,
    dp=dp,
    m=m,
    a=a,
...
experiment(StopTime=1.0),
  __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/PowerLawFixedM.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This examples demonstrates the
<a href=\"modelica://BrineGrid.Airflow.Multizone.BaseClasses.powerLaw\">
Buildings.Airflow.Multizone.BaseClasses.powerLaw</a>
and
<a href=\"modelica://BrineGrid.Airflow.Multizone.BaseClasses.powerLawFixedM\">
