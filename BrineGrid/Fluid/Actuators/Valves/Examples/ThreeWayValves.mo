...
model ThreeWayValves "Three way valves with different opening characteristics"
  ...
  package Medium = BrineGrid.Media.Water "Medium in the component";

  BrineGrid.Fluid.Actuators.Valves.ThreeWayLinear valLin(
  ...
  BrineGrid.Fluid.Sources.Boundary_pT ret(
    redeclare package Medium = Medium,
    nPorts=2,
    use_p_in=true,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/ThreeWayValves.mos"
        "Simulate and plot"),
