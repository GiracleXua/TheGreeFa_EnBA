within BrineGrid.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Examples;
model Convector
  extends Modelica.Icons.Example;

  package Medium = BrineGrid.Media.Water "Water model";

  BrineGrid.Fluid.Sources.MassFlowSource_T wat(
  ...
  BrineGrid.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector con(
    redeclare package Medium = Medium,
    nBeams=1,
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (experiment(StopTime=10),__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/BaseClasses/Examples/Convector.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
The example tests the implementation of
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector\">
BrineGrid.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector</a>.
