...
algorithm
  psat := BrineGrid.Utilities.Psychrometrics.Functions.saturationPressure(Tsat);
  annotation (
  smoothOrder=5,
  Inline=true);
...
<a href=\"modelica://BrineGrid.Media.Air.setState_psX\">
BrineGrid.Media.Air.setState_psX</a>.
</p>
<h4>Limitations</h4>
<p>
...
<a href=\"modelica://BrineGrid.Media.Air.specificEntropy\">
BrineGrid.Media.Air.specificEntropy</a>
for temperature.
</p>
</html>", revisions="<html>
<ul>
...
First implementation.
  ...
  constant GasProperties dryair(
    ...
    cp =   BrineGrid.Utilities.Psychrometrics.Constants.cpAir,
    cv =   BrineGrid.Utilities.Psychrometrics.Constants.cpAir
             -Modelica.Media.IdealGases.Common.SingleGasesData.Air.R)
    "Dry air properties";
  constant GasProperties steam(
    R =    Modelica.Media.IdealGases.Common.SingleGasesData.H2O.R,
    MM =   Modelica.Media.IdealGases.Common.SingleGasesData.H2O.MM,
    cp =   BrineGrid.Utilities.Psychrometrics.Constants.cpSte,
    cv =   BrineGrid.Utilities.Psychrometrics.Constants.cpSte
  ...
  constant Modelica.SIunits.SpecificHeatCapacity cpWatLiq=
    BrineGrid.Utilities.Psychrometrics.Constants.cpWatLiq
...
<a href=\"modelica://BrineGrid.Airflow.Multizone\">
BrineGrid.Airflow.Multizone</a> compute the mass density using the function
<a href=\"modelica://BrineGrid.Utilities.Psychrometrics.Functions.density_pTX\">
BrineGrid.Utilities.Psychrometrics.Functions.density_pTX</a> in which density
...
<h4>Note</h4>
<p>This model is identical to <a href=BrineGrid.Media.Air>BrineGrid.Media.Air</a>. It extends from
<a href=BrineGrid.Media.Interfaces.PartialCondensingFluid>BrineGrid.Media.Interfaces.PartialCondensingFluid</a>
to change the definition of <a href=BrineGrid.Media.Interfaces.PartialCondensingFluid.saturationPressure>
BrineGrid.Media.Interfaces.PartialCondensingFluid.saturationPressure</a>.</p>
</html>", revisions="<html>
<ul>
<li>
...
<a href=\"modelica://BrineGrid.Fluid.Sources.Examples.TraceSubstancesFlowSource\">
BrineGrid.Fluid.Sources.Examples.TraceSubstancesFlowSource</a>
...
<a href=\"modelica://BrineGrid.Utilities.Psychrometrics.Constants\">
BrineGrid.Utilities.Psychrometrics.Constants</a>.
...
<a href=\"modelica://BrineGrid.Media.GasesPTDecoupled.MoistAirUnsaturated.enthalpyOfNonCondensingGas\">
