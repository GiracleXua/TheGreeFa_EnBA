...
extends Modelica.Icons.Example;
  BrineGrid.BoundaryConditions.SolarGeometry.IncidenceAngle incAng(
    azi=0,
    lat=lat,
  ...
  BrineGrid.BoundaryConditions.SolarGeometry.BaseClasses.WallSolarAzimuth
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/WallSolarAzimuth.mos"
        "Simulate and plot"),
