within BrineGrid.Fluid.FMI.Adaptors;
model Outlet "Adaptor for connecting a fluid outlet to the FMI interface"
  ...
  BrineGrid.Fluid.FMI.Interfaces.Outlet outlet(
    ...
    redeclare final package Medium=Medium) "Fluid port"
        ...
        transformation(extent={{-110,-10},{-90,10}}),
          iconTransformation(extent={{-110,
            -10},{-90,10}})));
  BrineGrid.Fluid.FMI.Interfaces.PressureInput p if use_p_in
    "Pressure to be sent to outlet"
      ...
      Placement(transformation(
        ...
        origin={0,-120})));
protected
  BrineGrid.Fluid.FMI.Interfaces.FluidProperties bacPro_internal(
    redeclare final package Medium = Medium)
    "Internal connector for fluid properties for back flow";
  BrineGrid.Fluid.FMI.Interfaces.PressureOutput p_in_internal
    "Internal connector for pressure";

  BrineGrid.Fluid.FMI.Interfaces.MassFractionConnector X_w_in_internal
    "Internal connector for mass fraction of forward flow properties";
  BrineGrid.Fluid.FMI.Interfaces.MassFractionConnector X_w_out_internal
...
equation
  ...
  if not allowFlowReversal then
    ...
    if Medium.nXi > 0 then
      // This test for nXi is needed for BrineGrid.Fluid.FMI.Validation.HeaterFan_noReverseFlow
      // to work with BrineGrid.Media.Water
...
BrineGrid.Fluid.FMI.InletAdaptor</a> in order for
fluid mass flow rate and pressure to be properly assigned to
the acausal fluid models.
</p>
<p>
See
<a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.PartialTwoPortComponent\">
BrineGrid.Fluid.FMI.ExportContainers.PartialTwoPortComponent</a>
or
