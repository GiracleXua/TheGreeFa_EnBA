...
model TraceSubstances "Test model for the extra property sensor"
 ...
 parameter Modelica.SIunits.MassFlowRate m_flow_nominal = 15*1.2/3600
  ...
  BrineGrid.Fluid.Sensors.TraceSubstances senVol(
    redeclare package Medium = Medium) "Sensor at volume"
    annotation (Placement(transformation(extent={{100,50},{120,70}})));
  BrineGrid.Fluid.Sensors.TraceSubstances senSou(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Sensors.Conversions.To_VolumeFraction masFraSou(
    MMMea=Modelica.Media.IdealGases.Common.SingleGasesData.CO2.MM)
    "Conversion of mass ratio to volume ratio"
    annotation (Placement(transformation(extent={{140,90},{160,110}})));
  BrineGrid.Fluid.Sensors.Conversions.To_VolumeFraction masFraVol(
    MMMea=Modelica.Media.IdealGases.Common.SingleGasesData.CO2.MM)
    "Conversion of mass ratio to volume ratio"
    annotation (Placement(transformation(extent={{140,50},{160,70}})));
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSub(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSubNoFlorRev(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  BrineGrid.Fluid.Sensors.PPM senPPM(redeclare package Medium = Medium)
    "PPM sensor"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TraceSubstances.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort\">
BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort</a>.
</li>
<li>
