within BrineGrid.Fluid.HeatExchangers.Examples;
model WaterHeater_T
  "Example model for the heater with prescribed outlet temperature and water as the medium"
  extends Modelica.Icons.Example;
  extends BrineGrid.Fluid.HeatExchangers.Examples.BaseClasses.Heater(
    redeclare package Medium = BrineGrid.Media.Water,
...
First implementation.
    ...
    __Dymola_Commands(file= "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterHeater_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-05),
