...
extends Modelica.Icons.Example;
 package MediumW = BrineGrid.Media.Water "Medium model";
 package MediumA = BrineGrid.Media.Air "Medium model";
...
protected
  model SubModel
    ...
    BrineGrid.Fluid.Interfaces.StaticTwoPortConservationEquation conEqn(
      redeclare package Medium = Medium,
      m_flow_nominal=0.01,
      show_T=true,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/StaticTwoPortConservationEquation.mos"
        "Simulate and plot"),
