within BrineGrid.Fluid.HeatExchangers.ActiveBeams.Validation;
model NumberOfBeams
  extends Modelica.Icons.Example;

  package MediumA = BrineGrid.Media.Air "Medium model for air";

  package MediumW = BrineGrid.Media.Water "Medium model for water";

  parameter Integer nBeams(min=1) = 10 "Number of beams";

  BrineGrid.Fluid.Sources.FixedBoundary sin_1(
    redeclare package Medium = MediumW,
    nPorts=2) "Sink for chilled water"
    annotation (Placement(transformation(extent={{80,70},{60,90}})));
  BrineGrid.Fluid.Sources.MassFlowSource_T souAir(
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sin_3(
    redeclare package Medium = MediumA,
    nPorts=2)
    annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
  BrineGrid.Fluid.Sources.FixedBoundary sou_1(
    redeclare package Medium = MediumW,
    nPorts=2,
    T=288.15) "Source for chilled water"
    annotation (Placement(transformation(extent={{-120,68},{-100,88}})));
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumHotWat(
    redeclare package Medium = MediumW,
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sou_2(
    redeclare package Medium = MediumW,
    nPorts=2,
    T=320.95) "Source for hot water" annotation (Placement(transformation(extent={{-120,28},{-100,48}})));
  BrineGrid.Fluid.Sources.FixedBoundary sin_2(
    redeclare package Medium = MediumW,
    nPorts=2) "Sink for hot water"
    annotation (Placement(transformation(extent={{80,30},{60,50}})));
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumChiWat(
    redeclare package Medium = MediumW,
    m_flow_nominal=0.094,
    addPowerToMedium=false,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
  ...
  BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating beaCooHea(
    redeclare package MediumWat = MediumW,
    redeclare package MediumAir = MediumA,
    redeclare
      BrineGrid.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_length6ft_cooling perCoo,
    redeclare
      BrineGrid.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_length6ft_heating perHea,
    nBeams=1,
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T souAir10(
    redeclare package Medium = MediumA,
    use_m_flow_in=false,
    nPorts=1,
  ...
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumHotWat10(
    redeclare package Medium = MediumW,
    addPowerToMedium=false,
  ...
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumChiWat10(
    redeclare package Medium = MediumW,
    addPowerToMedium=false,
    m_flow_nominal=0.094*nBeams,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
  ...
  BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating beaCooHea10(
    redeclare package MediumWat = MediumW,
    redeclare package MediumAir = MediumA,
    redeclare
      BrineGrid.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_length6ft_cooling
      perCoo,
    redeclare
      BrineGrid.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_length6ft_heating
      perHea,
    nBeams=nBeams,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) "Active beam"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,
   ...
   __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Validation/NumberOfBeams.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating\">
BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating</a>,
one with
