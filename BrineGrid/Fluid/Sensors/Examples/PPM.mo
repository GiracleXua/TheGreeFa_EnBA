within BrineGrid.Fluid.Sensors.Examples;
model PPM "Test model for the extra property sensor outputting PPM"
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume volDyn(
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T mSou(
    redeclare package Medium = Medium,
    nPorts=2,
    m_flow=m_flow_nominal) "Fresh air supply"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  BrineGrid.Fluid.Sources.FixedBoundary sin(redeclare package Medium = Medium, nPorts=2)
    "Exhaust air"
    annotation (Placement(transformation(extent={{-40,-60},{-20,-40}})));

  BrineGrid.Fluid.Sensors.PPM senPPMVol(redeclare package Medium = Medium)
  ...
  BrineGrid.Fluid.Sensors.PPMTwoPort senPPMTwoPort(
    redeclare package Medium = Medium,
    ...
    m_flow_nominal=m_flow_nominal) "PPM sensor" annotation (Placement(
        ...
        rotation=90,
        origin={84,10})));
  BrineGrid.Fluid.Sensors.PPM senPPMIn(redeclare package Medium = Medium)
    "PPM sensor for inlet"
    annotation (Placement(transformation(extent={{-20,80},{0,100}})));
  BrineGrid.Fluid.Sensors.PPMTwoPort senPPMNoRev(
    redeclare package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={84,-30})));
  BrineGrid.Fluid.Sensors.PPMTwoPort senPPMRev(
    redeclare package Medium = Medium,
    allowFlowReversal=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={50,-50})));
  BrineGrid.Fluid.Sensors.PPMTwoPort senPPMSta(
    redeclare package Medium = Medium,
    allowFlowReversal=true,
    tau=0,
...
public
  BrineGrid.Fluid.MixingVolumes.MixingVolume volSte(
    redeclare package Medium = Medium,
    nPorts=3,
    V=1,
    use_C_flow=true,
  ...
  BrineGrid.Fluid.Sensors.PPM senPPMVol2(
                                      redeclare package Medium = Medium)
    "PPM sensor for mixing volume"
    annotation (Placement(transformation(extent={{120,80},{140,100}})));
  BrineGrid.Fluid.Sources.MassFlowSource_T mSouSta(
    redeclare package Medium = Medium,
    nPorts=1,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/PPM.mos"
        "Simulate and plot"),
