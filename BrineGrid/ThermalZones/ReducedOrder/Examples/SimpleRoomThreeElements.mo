within BrineGrid.ThermalZones.ReducedOrder.Examples;
model SimpleRoomThreeElements
  "Illustrates the use of a thermal zone with three heat conduction elements"
  extends Modelica.Icons.Example;

  BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    calTSky=BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation,
    computeWetBulbTemperature=false,
    filNam="modelica://BrineGrid/Resources/weatherdata/USA_CA_San.Francisco.Intl.AP.724940_TMY3.mos")
    "Weather data reader"
...
equation
  ...
  <a href=\"BrineGrid.ThermalZones.ReducedOrder.RC.ThreeElements\">
  BrineGrid.ThermalZones.ReducedOrder.RC.ThreeElements</a>
  in combination with
  <a href=\"BrineGrid.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow\">
  BrineGrid.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow</a>
  and
  <a href=\"BrineGrid.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane\">
  BrineGrid.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane</a>.
  Solar radiation on tilted surface is calculated using models of
  BrineGrid. The thermal zone is a simple room defined in Guideline
  ...
  relies on the standard weather file in BrineGrid.</p>
  ...
  "modelica://BrineGrid/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomThreeElements.mos"
        "Simulate and plot"));
