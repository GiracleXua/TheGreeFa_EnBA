...
model HVAC
  ...
  // otherwise, in BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones
...
protected
  ...
  BrineGrid.Fluid.FMI.Conversion.AirToOutlet con[nPorts](
      redeclare each final package Medium = Medium,
      each final allowFlowReversal=true)
  ...
  BrineGrid.Fluid.FMI.BaseClasses.X_w_toX x_w_toX(
    redeclare final package Medium = Medium) if Medium.nXi > 0
    "Conversion from X_w to X"
    ...
    Icon(coordinateSystem(
        ...
        Polygon(
          ...
          fillPattern=FillPattern.Solid),
            ...
            "modelica://BrineGrid/Resources/Images/Fluid/FMI/FMI_icon.png"),
            Bitmap(extent={{-96,52},{-24,108}},fileName=
            "modelica://BrineGrid/Resources/Images/Fluid/FMI/modelica_icon.png")}),
