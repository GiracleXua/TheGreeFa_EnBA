...
model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  BrineGrid.Fluid.Interfaces.PrescribedOutletState heaHigPow(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Interfaces.PrescribedOutletState cooLimPow(
    redeclare package Medium = Medium,
    Q_flow_maxCool=-1000,
    m_flow_small=1E-4*abs(m_flow_nominal),
    show_T=true,
  ...
  BrineGrid.Fluid.Interfaces.PrescribedOutletState heaCooUnl(
    redeclare package Medium = Medium,
    m_flow_small=1E-4*abs(m_flow_nominal),
    show_T=true,
    m_flow_nominal=m_flow_nominal)
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T sou3(
    redeclare package Medium = Medium,
    use_m_flow_in=true,
    T=293.15,
    nPorts=1) "Flow source"
...
__Dymola_Commands(file= "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/PrescribedOutletState.mos"
        "Simulate and plot"),
