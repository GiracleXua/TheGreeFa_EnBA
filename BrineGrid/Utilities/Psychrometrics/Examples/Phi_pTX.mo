...
model Phi_pTX "Model to test the relative humidity computation"
 ...
 package Medium = BrineGrid.Media.Air "Medium model"
  ...
  BrineGrid.Utilities.Psychrometrics.Phi_pTX phi "Relative humidity"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Phi_pTX.mos"
        "Simulate and plot"),
