...
initial algorithm
  ...
  d := BrineGrid.Utilities.Math.Functions.splineDerivatives(
    x=xd,
    y=yd,
    ensureMonotonicity=false);
  dMonotone := BrineGrid.Utilities.Math.Functions.splineDerivatives(x=xd, y=yd,
...
algorithm
  ...
  y := BrineGrid.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
    x=x,
    x1=xd[i],
    x2=xd[i + 1],
    y1=yd[i],
    ...
    y2d=d[i + 1]);
  yMonotone :=
    BrineGrid.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
    x=x,
    x1=xd[i],
    x2=xd[i + 1],
    y1=yd[i],
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/CubicHermite.mos"
        "Simulate and plot"),
...
<p align=\"center\"><img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Utilities/Math/Functions/Examples/cubicHermite.png\"/></p>
</html>", revisions="<html>
<ul>
<li>
