...
partial model PartialThreeWayValve "Partial three way valve"
  extends BrineGrid.Fluid.BaseClasses.PartialThreeWayResistance(
    final mDyn_flow_nominal = m_flow_nominal,
      ...
      BrineGrid.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1
        constrainedby BrineGrid.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          ...
          final CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
      ...
      redeclare replaceable
      BrineGrid.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3
        constrainedby BrineGrid.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          dp(start=dpValve_nominal/2),
          from_dp=from_dp,
