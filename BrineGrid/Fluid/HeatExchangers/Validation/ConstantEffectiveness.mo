...
model ConstantEffectiveness
 ...
 package Medium1 = BrineGrid.Media.Water;
 package Medium2 = BrineGrid.Media.Air;
  BrineGrid.Fluid.Sources.Boundary_pT sin_2(
  ...
  BrineGrid.Fluid.Sources.Boundary_pT sou_2(
  ...
  BrineGrid.Fluid.Sources.Boundary_pT sou_1(
    ...
    nPorts=1)             annotation (Placement(transformation(extent={{-60,36},
            {-40,56}})));
  BrineGrid.Fluid.HeatExchangers.ConstantEffectiveness hex(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/ConstantEffectiveness.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This model tests
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.ConstantEffectiveness\">
BrineGrid.Fluid.HeatExchangers.ConstantEffectiveness</a>
