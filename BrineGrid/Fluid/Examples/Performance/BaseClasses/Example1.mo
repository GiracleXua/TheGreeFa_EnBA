within BrineGrid.Fluid.Examples.Performance.BaseClasses;
partial model Example1 "Example 1 partial model"
  ...
  BrineGrid.Fluid.HeatExchangers.HeaterCooler_T hea(
    redeclare package Medium = Medium,
    dp_nominal=1000,
    Q_flow_maxHeat=1000,
    Q_flow_maxCool=0,
  ...
  BrineGrid.Fluid.Actuators.Valves.ThreeWayLinear val(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop[nRes.k] res(
    redeclare package Medium = Medium,
...
<a href=\"modelica://BrineGrid.Fluid.Examples.Performance.Example1v1\">
BrineGrid.Fluid.Examples.Performance.Example1v1</a>
and
<a href=\"modelica://BrineGrid.Fluid.Examples.Performance.Example1v2\">
BrineGrid.Fluid.Examples.Performance.Example1v2</a>
