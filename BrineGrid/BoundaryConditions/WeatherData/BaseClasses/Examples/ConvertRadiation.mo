...
model ConvertRadiation "Test model for ConvertRadiation"
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.ConvertTime timCon
...
__Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertRadiation.mos"
        "Simulate and plot"));
