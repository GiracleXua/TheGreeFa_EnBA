...
model ConvertRelativeHumidity
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity conRelHum
...
__Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertRelativeHumidity.mos"
        "Simulate and plot"));
