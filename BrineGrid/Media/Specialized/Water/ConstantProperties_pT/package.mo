...
<a href=\"modelica://BrineGrid.Media.Water\">BrineGrid.Media.Water</a> with regard to its
...
<pre>
  package Medium = BrineGrid.Media.Specialized.Water.ConstantProperties_pT(
