...
model PerfectGasTestImplementation
  ...
  extends Modelica.Media.Examples.Tests.Components.PartialTestModel(
     redeclare package Medium =
          BrineGrid.Media.Specialized.Air.PerfectGas);

      annotation (experiment(StopTime=1.0),
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Media/Specialized/Air/Examples/PerfectGasTestImplementation.mos"
        "Simulate and plot"),
