...
model TWetBul_TDryBulXi
 ...
 package Medium = BrineGrid.Media.Air "Medium model"
  ...
  BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBul(         redeclare
  ...
  BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulApp(redeclare
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/TWetBul_TDryBulXi.mos"
        "Simulate and plot"),
