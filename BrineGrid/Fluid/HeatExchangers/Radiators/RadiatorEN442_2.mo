within BrineGrid.Fluid.HeatExchangers.Radiators;
model RadiatorEN442_2 "Dynamic radiator for space heating"
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume[nEle] vol(
...
protected
  ...
  Modelica.Blocks.Sources.RealExpression QCon[nEle](y={if homotopyInitialization
        ...
        BrineGrid.Utilities.Math.Functions.regNonZeroPower(
...
initial equation
  ...
  for i in 1:nEle loop
    ...
    QEle_flow_nominal[i] = k * UAEle * (fraRad *
      BrineGrid.Utilities.Math.Functions.powerLinearized(
