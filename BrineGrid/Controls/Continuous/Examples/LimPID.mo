...
model LimPID "Test model for PID controller with optional reverse action"
  ...
  BrineGrid.Controls.Continuous.LimPID limPIDRev(
    controllerType=Modelica.Blocks.Types.SimpleController.PID,
    reverseAction=true,
    Ti=1,
    Td=1,
  ...
  BrineGrid.Utilities.Diagnostics.AssertEquality assertEquality(
    threShold=1e-3)
  ...
  BrineGrid.Utilities.Diagnostics.AssertEquality assertEquality1(
    threShold=1e-3)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPID.mos"
        "Simulate and plot"),
...
from the BrineGrid library. The model
