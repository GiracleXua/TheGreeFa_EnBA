...
model ZonalFlow "Model with prescribed air exchange between two volumes"
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume rooA(
    V=volA,
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume rooB(
    V=volB,
    redeclare package Medium = Medium,
    X_start={0.01,0.99},
    T_start=293.15,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ZonalFlow.mos"
        "Simulate and plot"),
