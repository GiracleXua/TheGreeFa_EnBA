...
equation
  alpha = winDir-surOut;
  CpAct = BrineGrid.Airflow.Multizone.BaseClasses.windPressureLowRise(
...
<code>BrineGrid.Types.Azimuth.S</code>.
</p>
<p>
