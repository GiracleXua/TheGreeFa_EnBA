...
model BooleanReplicator "Test model for boolean replicator"
  ...
  BrineGrid.Utilities.Math.BooleanReplicator booRep(nout=
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Math/Examples/BooleanReplicator.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BrineGrid.Utilities.Math.BooleanReplicator\">
BrineGrid.Utilities.Math.BooleanReplicator</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
