...
model ChimneyShaftNoVolume
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume roo(
    V=2.5*5*5,
  ...
  BrineGrid.Airflow.Multizone.Orifice oriChiTop(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  BrineGrid.Fluid.Sources.MassFlowSource_T boundary(
    redeclare package Medium = Medium,
    use_m_flow_in=true,
    T=293.15,
    nPorts=1)
    annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  BrineGrid.Fluid.Sources.Boundary_pT bou0(
    redeclare package Medium = Medium,
    T=273.15,
    nPorts=2) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={90,50})));
  BrineGrid.Airflow.Multizone.Orifice oriBot(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) annotation (Placement(transformation(
        origin={110,-20},
  ...
  BrineGrid.Airflow.Multizone.Orifice oriChiBot(
    m=0.5,
    redeclare package Medium = Medium,
    A=0.01) annotation (Placement(transformation(
        origin={70,-49},
  ...
  BrineGrid.Airflow.Multizone.MediumColumn sha(redeclare package Medium = Medium,
      densitySelection=BrineGrid.Airflow.Multizone.Types.densitySelection.actual) "Shaft of chimney"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},
            {140,100}})),
    __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ChimneyShaftNoVolume.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
