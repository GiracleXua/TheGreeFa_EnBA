...
connector MoisturePorts_b
  ...
  annotation (defaultComponentName="massPorts_b",
...
except that the icon has been modified. It can be used to represent an array of <a href=\"modelica://BrineGrid.MassTransfer.Interfaces.MoisturePort_b\">
MoisturePort_b</a>.</p>
</html>", revisions="<html>
<ul>
<li>
