...
model SolarTime "Test model for solar time"
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.SolarTime solTim
    "Block that computes the solar time"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.EquationOfTime eqnTim
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/SolarTime.mos"
        "Simulate and plot"));
end SolarTime;
