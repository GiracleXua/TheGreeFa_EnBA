...
equation
  ...
  Q_flow = if homotopyInitialization then
    homotopy(actual=BrineGrid.Utilities.Math.Functions.regStep(
                      y1=QThe_flow,
                      y2=0,
      ...
      BrineGrid.Utilities.Math.Functions.regStep(
                      y1=QThe_flow,
                      y2=0,
                      x=noEvent(abs(V_flow))-2*delta_V_flow,
                      x_small=delta_V_flow);
...
<a href=\"modelica://BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine\">
BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine</a>.
</p>
</html>",
      revisions="<html>
<ul>
