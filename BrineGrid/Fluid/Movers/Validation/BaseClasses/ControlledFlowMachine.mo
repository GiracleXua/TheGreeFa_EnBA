within BrineGrid.Fluid.Movers.Validation.BaseClasses;
model ControlledFlowMachine
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFloRat1(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  BrineGrid.Fluid.Sensors.RelativePressure relPre(redeclare package Medium =
        Medium) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        origin={-10,32})));
  BrineGrid.Fluid.Movers.SpeedControlled_y fan1(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFloRat2(
    redeclare package Medium = Medium)
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFloRat3(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  BrineGrid.Fluid.Movers.FlowControlled_dp fan3(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    annotation (Placement(transformation(extent={{-20,-70},{0,-50}})));
  BrineGrid.Fluid.Movers.FlowControlled_m_flow fan2(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFloRat4(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  BrineGrid.Fluid.Movers.SpeedControlled_Nrpm fan4(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
