within BrineGrid.Fluid.Actuators.Motors;
...
the model <a href=\"modelica://BrineGrid.Fluid.Examples.TwoWayValves\">
BrineGrid.Fluid.Examples.TwoWayValves</a> sets <code>y=3</code>
