...
partial model FlowMachine_ZeroFlow
  ...
  replaceable package Medium = BrineGrid.Media.Air
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop dpSta(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
    annotation (Placement(transformation(extent={{58,70},{78,90}})));
  replaceable BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine floMacSta
    constrainedby BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine(
      redeclare package Medium = Medium,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Static model of a flow machine"
    annotation (Placement(transformation(extent={{20,70},{40,90}})));
  replaceable BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine floMacDyn
    constrainedby BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine(
      redeclare package Medium = Medium,
      energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Dynamic model of a flow machine"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  BrineGrid.Fluid.FixedResistances.PressureDrop dpDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop dpSta1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
    annotation (Placement(transformation(extent={{-20,70},{0,90}})));
  BrineGrid.Fluid.FixedResistances.PressureDrop dpDyn1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
...
<a href=\"modelica://BrineGrid.Fluid.Movers.Validation.SpeedControlled_Nrpm_Data\">
BrineGrid.Fluid.Movers.Validation.SpeedControlled_Nrpm_Data</a>
