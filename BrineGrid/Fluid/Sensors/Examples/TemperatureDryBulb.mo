...
model TemperatureDryBulb "Test model for the dry bulb temperature sensor"
 ...
 package Medium = BrineGrid.Media.Air "Medium model";
  BrineGrid.Fluid.Sources.Boundary_pT amb(
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort temSteSta(
   redeclare package Medium = Medium,
   m_flow_nominal=2,
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort temDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort temDynLoss(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    initType=Modelica.Blocks.Types.Init.InitialState,
    transferHeat=true,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TemperatureDryBulb.mos"
        "Simulate and plot"),
