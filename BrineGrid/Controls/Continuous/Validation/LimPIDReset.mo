within BrineGrid.Controls.Continuous.Validation;
model LimPIDReset
  ...
  BrineGrid.Controls.Continuous.LimPID limPIDPar(
    yMax=1,
    yMin=-1,
    reset=BrineGrid.Types.Reset.Parameter,
    y_reset=0.2,
    Ti=20,
    Td=10,
    k=0.2,
  ...
  BrineGrid.Controls.Continuous.LimPID limPIDDef(
  ...
  BrineGrid.Controls.Continuous.LimPID limPIDInp(
    y_reset=0.2,
    Td=10,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Controls/Continuous/Validation/LimPIDReset.mos"
        "Simulate and plot"),
...
<a href=\"Modelica://BrineGrid.Controls.Continuous.LimPID\">BrineGrid.Controls.Continuous.LimPID</a>
