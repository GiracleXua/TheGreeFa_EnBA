...
model MoistAirEnthalpyFlowRate
  ...
  BrineGrid.Fluid.Sensors.EnthalpyFlowRate senH_flow(
  ...
  BrineGrid.Fluid.Sensors.SpecificEnthalpyTwoPort senH(
    redeclare package Medium = Medium,
    m_flow_nominal=1) "Specific enthalpy sensor"
                annotation (Placement(transformation(extent={{0,10},{20,30}})));
  BrineGrid.Fluid.Sensors.MassFlowRate senM_flow(
  ...
  BrineGrid.Fluid.Sensors.LatentEnthalpyFlowRate senHLat_flow(
    redeclare package Medium = Medium,
    m_flow_nominal=1) "Latent enthalpy flow rate sensor"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  BrineGrid.Fluid.Sensors.SensibleEnthalpyFlowRate senHSen_flow(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/MoistAirEnthalpyFlowRate.mos"
        "Simulate and plot"),
    Documentation(
    info="<html>
<p>
