...
model PressureDropsSeries "Test of multiple resistances in series"
 ...
 package Medium = BrineGrid.Media.Air "Medium model";
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop[nRes] res(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsSeries.mos"
        "Simulate and plot"),
