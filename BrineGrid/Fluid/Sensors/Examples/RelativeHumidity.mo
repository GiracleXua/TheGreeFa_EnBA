...
model RelativeHumidity "Test model for relative humidity sensor"
  ...
  BrineGrid.Fluid.Sensors.RelativeHumidity senRelHum(
    redeclare package Medium = Medium)
  ...
  BrineGrid.Fluid.Sensors.RelativeHumidityTwoPort relHum(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/RelativeHumidity.mos"
        "Simulate and plot"),
