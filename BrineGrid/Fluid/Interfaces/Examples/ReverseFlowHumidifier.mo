...
package Medium = BrineGrid.Media.Air;
  ...
  BrineGrid.Fluid.MassExchangers.Humidifier_u humBac(
  ...
  BrineGrid.Fluid.MassExchangers.Humidifier_u humFor(
    redeclare package Medium = Medium,
    dp_nominal=0,
    m_flow(start=1),
    m_flow_nominal=1,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowHumidifier.mos"
        "Simulate and plot"),
