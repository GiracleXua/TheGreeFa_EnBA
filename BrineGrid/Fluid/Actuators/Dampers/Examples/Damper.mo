...
model Damper
  ...
  BrineGrid.Fluid.Actuators.Dampers.Exponential res(
    A=1,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/Damper.mos"
        "Simulate and plot"),
