...
model PowerInterface "Simple model to validate PowerInterface"
  ...
  BrineGrid.Fluid.Movers.BaseClasses.PowerInterface powCoo(
  ...
  BrineGrid.Fluid.Movers.BaseClasses.PowerInterface powNonCoo(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/PowerInterface.mos"
        "Simulate and plot"));
end PowerInterface;
