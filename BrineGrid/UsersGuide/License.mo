...
<body lang=\"en-US\">
    ...
    Original Work:</p>
    <p><strong>Licensed by Yannick Fürst, TU Berlin, Hermann-Rietschel-Institute
    under the Modelica License&nbsp;2.</strong></p>
    <p><b>This library uses the Annex60 library. For more information about the
    Annex60 library and its license, visit <a href=\"https://github.com/iea-annex60/modelica-annex60\">
        https://github.com/iea-annex60/modelica-annex60</a>.</b></p>
    ...
    document.</p>
    <p><strong>Can I copy a text passage out of a Modelica document (under
    Modelica License&nbsp;2) and us" + "e it in</strong>
