...
model StructuredPackingDehumidification_ZhangHiharaMatsuokaDang
  "Structured packing: Convective mass transfer correlation from Zhang, Hihara, Matsuoka and Dang for dehumidification"
...
equation
  ...
  Sc_b = BrineGrid.Fluid.Functions.CharacteristicNumbers.SchmidtNumber(
    ...
    rho=rho_b,
    D=D_abs);
  Sh = 0.0038*Re_a^(0.52)*Sc_a^(0.33)*Re_b^(0.28)*Sc_b^(0.33);
...
<li>dehumidification processes and</li>
...
end StructuredPackingDehumidification_ZhangHiharaMatsuokaDang;
