within BrineGrid.Utilities.Psychrometrics;
...
equation
  if approximateWetBulb then
    ...
    XiSat  = BrineGrid.Utilities.Psychrometrics.Functions.X_pSatpphi(
      pSat = BrineGrid.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TWetBul),
      p =    p,
      phi =  1);
    XiDryBul =BrineGrid.Utilities.Psychrometrics.Functions.X_pSatpphi(
      p =    p,
      pSat = BrineGrid.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TDryBul),
      phi =  phi);
    (TWetBul-BrineGrid.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * BrineGrid.Utilities.Psychrometrics.Constants.cpAir +
              XiSatRefIn * BrineGrid.Utilities.Psychrometrics.Constants.cpSte +
              (XiDryBul-XiSatRefIn) * BrineGrid.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-BrineGrid.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * BrineGrid.Utilities.Psychrometrics.Constants.cpAir +
              XiDryBul * BrineGrid.Utilities.Psychrometrics.Constants.cpSte)  +
    (XiDryBul-XiSatRefIn) * BrineGrid.Utilities.Psychrometrics.Constants.h_fg;
...
<a href=\"modelica://BrineGrid.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi\">
BrineGrid.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi</a>.
</p>
<p>
For a model that takes the mass fraction instead of the relative humidity as an input, see
<a href=\"modelica://BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulXi\">
BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulXi</a>.
</p>
<h4>References</h4>
<p>
Stull, Roland.
...
<code>BrineGrid.Utilities.Psychrometrics.Functions.saturationPressure()</code>
and
<code>BrineGrid.Utilities.Psychrometrics.Functions.saturationPressureLiquid()</code>
