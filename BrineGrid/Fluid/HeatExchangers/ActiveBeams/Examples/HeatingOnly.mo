within BrineGrid.Fluid.HeatExchangers.ActiveBeams.Examples;
model HeatingOnly
  ...
  BrineGrid.Fluid.Sources.FixedBoundary bou(
    redeclare package Medium = MediumA,
  ...
  BrineGrid.Controls.Continuous.LimPID conPID(
    yMax=0.094,
    Td=0,
    reverseAction=false,
    Ti=100,
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume vol(nPorts=2,
    redeclare package Medium = MediumA,
    m_flow_nominal=0.1,
    V=30,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(StopTime=172800),__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/HeatingOnly.mos"
        "Simulate and plot"),
    Icon(coordinateSystem(extent={{-120,-120},{120,120}})),
     Documentation(info="<html>
<p>
This example tests the implementation of <a href=\"modelica://BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating\">
BrineGrid.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating</a>, but operates it only in heating mode.
