...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/Carnot_TCon_LimitedCapacity.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example extends from
<a href=\"modelica://BrineGrid.Fluid.HeatPumps.Examples.Carnot_TCon\">
BrineGrid.Fluid.HeatPumps.Examples.Carnot_TCon</a>
