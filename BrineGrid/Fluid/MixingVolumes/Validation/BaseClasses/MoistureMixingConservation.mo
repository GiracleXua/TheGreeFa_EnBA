within BrineGrid.Fluid.MixingVolumes.Validation.BaseClasses;
partial model MoistureMixingConservation
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_h sou1(
    redeclare package Medium = Medium,
    nPorts=1,
    m_flow=2,
    X={0,1}) "Air source"
    annotation (Placement(transformation(extent={{-100,10},{-80,30}})));
  BrineGrid.Fluid.Sources.MassFlowSource_h sou2(
    redeclare package Medium = Medium,
    nPorts=1,
    m_flow=1,
    X={0,1}) "Air source"
    annotation (Placement(transformation(extent={{-100,-30},{-80,-10}})));
  BrineGrid.Fluid.MixingVolumes.MixingVolumeMoistAir vol(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolumeMoistAir vol1(
    ...
    "Mixing volume for adding water"
    annotation (Placement(transformation(extent={{-60,-20},{-40,-40}})));
  BrineGrid.Fluid.Sources.Boundary_pT sin(redeclare package Medium = Medium,
      nPorts=1) "Air sink"
  ...
  BrineGrid.Fluid.Sensors.MassFractionTwoPort senMasFra(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0,
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate senMasFlo(redeclare package Medium =
