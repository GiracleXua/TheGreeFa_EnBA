...
equation
  y=BrineGrid.Utilities.Math.Functions.spliceFunction(
    pos=u1,
    neg= u2,
    x= x,
    deltax= deltax);
...
<p>
This block implements <a href=\"modelica://BrineGrid.Utilities.Math.Functions.spliceFunction\">
BrineGrid.Utilities.Math.Functions.spliceFunction</a>, which provides a continuously differentiable transition between two arguments.
</p>
</html>",
revisions="<html>
<ul>
