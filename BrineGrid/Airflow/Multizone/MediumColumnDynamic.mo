...
model MediumColumnDynamic
  ...
  MediumColumn colTop(
    redeclare final package Medium = Medium,
    final densitySelection=BrineGrid.Airflow.Multizone.Types.densitySelection.fromBottom,
    h=h/2,
  ...
  MediumColumn colBot(
    redeclare final package Medium = Medium,
    final densitySelection=BrineGrid.Airflow.Multizone.Types.densitySelection.fromTop,
    h=h/2,
    final allowFlowReversal=allowFlowReversal)
...
<a href=\"modelica://BrineGrid.Airflow.Multizone.MediumColumn\">
BrineGrid.Airflow.Multizone.MediumColumn</a> instead of this model.
</p>
