...
<tr><th valign=\"top\" align=\"left\">Correct use</th>
    <td valign=\"top\">
    <img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/Sensors/twoPortHex.png\" />
    </td>
</tr>
<tr><th valign=\"top\" align=\"left\">Not recommended</th>
    <td valign=\"top\">
    <img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/Sensors/onePortHex.png\" />
    </td>
</tr>
</table>
...
<p>
For the sensor
<a href=\"modelica://BrineGrid.Fluid.Sensors.TemperatureTwoPort\">
BrineGrid.Fluid.Sensors.TemperatureTwoPort</a>,
