...
model ControlledFlowMachineDynamic
  ...
  extends BrineGrid.Fluid.Movers.Validation.BaseClasses.ControlledFlowMachine(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/ControlledFlowMachineDynamic.mos"
        "Simulate and plot"),
