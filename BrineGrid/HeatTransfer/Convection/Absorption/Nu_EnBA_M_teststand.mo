...
model Nu_EnBA_M_teststand
  ...
  Real [6] param_Nu = {27178.4078, 1.40099074, 19.1874858, 0.284449306, -5.48767709, -1.37314023};
equation
  ...
  Re = BrineGrid.Fluid.Functions.CharacteristicNumbers.ReynoldsNumber_m_flow(
    ...
    L=deq,
    A=crossArea);
  Nu = (param_Nu[1])*(Re/2300)^(param_Nu[2])*Pr^(param_Nu[3])*(m_flow_in_b/m_flow_in_a)^(param_Nu[4])*(x_eq/x-1)^(param_Nu[5])*((T_b - 273.15)/(T_a - 273.15))^(param_Nu[6]);
