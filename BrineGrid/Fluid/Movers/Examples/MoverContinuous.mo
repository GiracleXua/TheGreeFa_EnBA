...
model MoverContinuous
  ...
  extends MoverParameter(
    pump_Nrpm(inputType=BrineGrid.Fluid.Types.InputType.Continuous),
    pump_m_flow(inputType=BrineGrid.Fluid.Types.InputType.Continuous),
    pump_y(inputType=BrineGrid.Fluid.Types.InputType.Continuous),
    pump_dp(inputType=BrineGrid.Fluid.Types.InputType.Continuous));
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Examples/MoverContinuous.mos"
        "Simulate and plot"));
end MoverContinuous;
