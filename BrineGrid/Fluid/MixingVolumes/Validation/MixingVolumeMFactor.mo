...
model MixingVolumeMFactor
  ...
  extends BrineGrid.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow(
  sou(X={0.02,0.98},
      T=Medium.T_default),
  vol(mSenFac=10),
    bou(nPorts=3));
  BrineGrid.Fluid.MixingVolumes.MixingVolume volMFactor(
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T boundaryMFactor(
    redeclare package Medium = Medium,
    T=300,
    nPorts=1,
    m_flow=1,
...
<p>
See
<a href=\"modelica://BrineGrid.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow\">
BrineGrid.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow</a>
...
First implementation.
          ...
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeMFactor.mos"
        "Simulate and plot"));
