...
model BasicFlowFunction_m_flow_DerivativeCheck2
  ...
  BrineGrid.Utilities.Diagnostics.CheckEquality cheEqu1(
    threShold=1e-3) "Block for checking integration error";
...
equation
  ...
  // in BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der2
  m_flow = time^3/8;
...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-8),
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/BasicFlowFunction_m_flow_DerivativeCheck2.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der2\">
BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der2</a>.
