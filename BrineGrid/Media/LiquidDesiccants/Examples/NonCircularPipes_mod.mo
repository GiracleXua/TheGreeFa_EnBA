...
model NonCircularPipes_mod
  ...
  Modelica.Fluid.Sources.MassFlowSource_T massflowsink1(                                   nPorts = 1,
    use_m_flow_in=false,
    m_flow=1,
    X={0.8,0.2},
    redeclare package Medium = MagnesiumChlorideAqueousSolution,
    T=303.15)                                                                                                                     annotation(Placement(transformation(origin = {40, 40}, extent = {{10, -10}, {-10, 10}})));
  Modelica.Fluid.Sources.MassFlowSource_T massflowsink2(                                   nPorts = 1,
    m_flow=2,
    X={0.7,0.3},
    redeclare package Medium = MagnesiumChlorideAqueousSolution,
    T=313.15)                                                                                                                     annotation(Placement(transformation(origin = {40, -40}, extent = {{10, -10}, {-10, 10}})));
