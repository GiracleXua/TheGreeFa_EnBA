...
model CheckRelativeHumidity "Test model for CheckRelativeHumidity"
  extends
    BrineGrid.BoundaryConditions.WeatherData.BaseClasses.Examples.ConvertRelativeHumidity;

  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckRelativeHumidity cheRelHum
...
__Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckRelativeHumidity.mos"
        "Simulate and plot"));
