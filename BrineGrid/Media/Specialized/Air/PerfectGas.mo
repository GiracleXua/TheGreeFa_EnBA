within BrineGrid.Media.Specialized.Air;
...
function saturationPressureLiquid
  ...
  // BrineGrid.Fluid.Sensors.Examples.MassFraction
algorithm
  psat := 611.657*Modelica.Math.exp(17.2799 - 4102.99/(Tsat - 35.719));
  annotation (
    smoothOrder=5,
    Inline=true,
    derivative=BrineGrid.Media.Specialized.Air.PerfectGas.saturationPressureLiquid_der,
    Documentation(info="<html>
...
algorithm
  psat := BrineGrid.Utilities.Math.Functions.regStep(
...
<a href=\"modelica://BrineGrid.Media.Air\">BrineGrid.Media.Air</a>
