...
model NaturalVentilation
  ...
  BrineGrid.Airflow.Multizone.MediumColumn colOut(
    redeclare package Medium = Medium,
    h=3,
  ...
  BrineGrid.Airflow.Multizone.MediumColumn colRooTop(
    redeclare package Medium = Medium,
    h=3,
    densitySelection=BrineGrid.Airflow.Multizone.Types.densitySelection.fromBottom)
...
experiment(StopTime=7200),
    __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Airflow/Multizone/Examples/NaturalVentilation.mos"
        "Simulate and plot"),
