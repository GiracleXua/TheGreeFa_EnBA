within BrineGrid.Fluid.MixingVolumes.BaseClasses;
...
protected
  BrineGrid.Fluid.Interfaces.StaticTwoPortConservationEquation steBal(
  ...
  BrineGrid.Fluid.Interfaces.ConservationEquation dynBal(
    final simplify_mWat_flow = simplify_mWat_flow,
    final use_C_flow = use_C_flow,
    redeclare final package Medium = Medium,
  ...
  // See BrineGrid, issue 282 for a discussion.
...
<a href=\"modelica://BrineGrid.Fluid.MixingVolumes\">
BrineGrid.Fluid.MixingVolumes</a>.
</p>
...
<a href=\"modelica://BrineGrid.Fluid.MixingVolumes.BaseClasses.PartialMixingVolumeWaterPort\">
BrineGrid.Fluid.MixingVolumes.BaseClasses.PartialMixingVolumeWaterPort</a>,
