within BrineGrid.Fluid.FixedResistances.Validation;
model PressureDropsExplicit "Test of multiple resistances in series"
  extends Modelica.Icons.Example;

 package Medium = BrineGrid.Media.Air "Medium model";
  BrineGrid.Fluid.Sources.Boundary_ph sou(
  ...
  BrineGrid.Fluid.Sources.Boundary_ph sin(
    redeclare package Medium = Medium,
    nPorts=1,
    use_p_in=false,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res11(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res12(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res22(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res21(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res31(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res32(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res42(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop res41(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_h bou(
    redeclare package Medium = Medium,
    m_flow=1,
    nPorts=1) "Mass flow boundary condition"
    annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));

  BrineGrid.Fluid.Sources.MassFlowSource_h bou1(
    redeclare package Medium = Medium,
    m_flow=1,
    nPorts=1) "Mass flow boundary condition"
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));

  BrineGrid.Fluid.Sources.Boundary_pT sin1(
    redeclare package Medium = Medium,
    T=273.15 + 10,
    nPorts=2,
    use_p_in=false,
  ...
  BrineGrid.Fluid.Sources.Boundary_ph sin2(
    redeclare package Medium = Medium,
    nPorts=1,
    use_p_in=false,
    p=101325) "Pressure boundary condition"
  ...
  BrineGrid.Fluid.Sources.Boundary_ph sou1(
    redeclare package Medium = Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true) "Pressure boundary condition"
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate senMasFlo1(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,90},{80,110}})));

  BrineGrid.Fluid.Sensors.MassFlowRate senMasFlo2(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));

  BrineGrid.Fluid.Sensors.MassFlowRate senMasFlo3(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-20},{80,0}})));

  BrineGrid.Fluid.Sensors.MassFlowRate senMasFlo4(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-60},{80,-40}})));

  BrineGrid.Utilities.Diagnostics.AssertEquality assertEquality(threShold=1E-1)
    "Assert equality of the two mass flow rates"
    annotation (Placement(transformation(extent={{120,120},{140,140}})));

  BrineGrid.Utilities.Diagnostics.AssertEquality assertEquality1(threShold=1E-1)
    "Assert equality of the two mass flow rates"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsExplicit.mos"
        "Simulate and plot"),
