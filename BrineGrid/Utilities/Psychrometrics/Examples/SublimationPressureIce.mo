...
model SublimationPressureIce
  ...
  BrineGrid.Utilities.Psychrometrics.SublimationPressureIce pSat
    "Saturation pressure"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/SublimationPressureIce.mos"
        "Simulate and plot"),
