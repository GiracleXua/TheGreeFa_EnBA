within BrineGrid.Fluid.FMI.Adaptors.Examples;
model ThermalZoneHVACWithExhaust
  "Example of a thermal zone and an HVAC system both exposed using the FMI adaptor"
  extends BrineGrid.Fluid.FMI.Adaptors.Examples.ThermalZoneHVACNoExhaust(
    hvacAda(nPorts=3),
    out(nPorts=3),
    con(nPorts=3),
    vol(nPorts=3));
...
use the adaptors
<a href=\"modelica://BrineGrid.Fluid.FMI.Adaptors.HVAC\">
BrineGrid.Fluid.FMI.Adaptors.HVAC</a>
and
<a href=\"modelica://BrineGrid.Fluid.FMI.Adaptors.ThermalZone\">
BrineGrid.Fluid.FMI.Adaptors.ThermalZone</a>
</p>
<p>
It is identical to
<a href=\"BrineGrid.Fluid.FMI.Adaptors.Examples.ThermalZoneHVACNoExhaust\">
BrineGrid.Fluid.FMI.Adaptors.Examples.ThermalZoneHVACNoExhaust</a>
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/Adaptors/Examples/ThermalZoneHVACWithExhaust.mos"
        "Simulate and plot"),
