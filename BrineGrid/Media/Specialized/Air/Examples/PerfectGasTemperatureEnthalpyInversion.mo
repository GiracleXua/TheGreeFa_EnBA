within BrineGrid.Media.Specialized.Air.Examples;
model PerfectGasTemperatureEnthalpyInversion
  ...
  extends BrineGrid.Media.Examples.BaseClasses.TestTemperatureEnthalpyInversion(
    redeclare package Medium = BrineGrid.Media.Specialized.Air.PerfectGas);
  annotation (
experiment(StopTime=1.0),
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Media/Specialized/Air/Examples/PerfectGasTemperatureEnthalpyInversion.mos"
        "Simulate and plot"),
