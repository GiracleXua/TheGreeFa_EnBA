...
model Pump_stratos "Stratos pumps with speed as input"
 ...
 extends BrineGrid.Fluid.Movers.Validation.BaseClasses.FlowMachine_ZeroFlow(
    ...
    redeclare BrineGrid.Fluid.Movers.SpeedControlled_Nrpm floMacSta(
      redeclare package Medium = Medium,
      filteredSpeed=false,
      per=per),
    redeclare BrineGrid.Fluid.Movers.SpeedControlled_Nrpm floMacDyn(
      redeclare package Medium = Medium,
      filteredSpeed=false,
      per=per));
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Movers/Validation/Pump_stratos.mos"
        "Simulate and plot"),
