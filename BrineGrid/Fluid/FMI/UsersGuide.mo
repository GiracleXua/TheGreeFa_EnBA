...
<tr>
  <td>
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers\">
  BrineGrid.Fluid.FMI.ExportContainers</a>
  </td>
  <td>
  <p>
  ...
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.ReplaceableTwoPort\">
  BrineGrid.Fluid.FMI.ExportContainers.ReplaceableTwoPort</a>
  with a replaceable model,
  or extend from
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.PartialTwoPort\">
  BrineGrid.Fluid.FMI.ExportContainers.PartialTwoPort</a>
  and add components.<br/>
  See
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.Fan\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.Fan</a>
  and
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume</a>.
  </p>
  <p>
  ...
  See
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone</a>.
  </p>
  <p>
  To export an HVAC system that serves multiple thermal zones, extend from
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.HVACZones\">
  BrineGrid.Fluid.FMI.ExportContainers.HVACZones</a>
  and add the HVAC system.<br/>
  See
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones</a>.
  </p>
  <p>
  To export a single thermal zone, extend from
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.ThermalZone\">
  BrineGrid.Fluid.FMI.ExportContainers.ThermalZone</a>
  and add the thermal zone.<br/>
  See
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone</a>.
  </p>
  <p>
  To export multiple thermal zones, extend from
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.ThermalZones\">
  BrineGrid.Fluid.FMI.ExportContainers.ThermalZones</a>
  and add the thermal zone models.<br/>
  See
  <a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZones\">
  BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZones</a>.
  </p>
  </td>
</tr>
<tr>
  <td>
  <a href=\"modelica://BrineGrid.Fluid.FMI.Adaptors\">
  BrineGrid.Fluid.FMI.Adaptors</a>
  </td>
  <td>
  <p>
...
<td>
  <p>
  <a href=\"modelica://BrineGrid.Fluid.FMI.Conversion\">
  BrineGrid.Fluid.FMI.Conversion</a>
  </p>
</td>
<td>
  <p>
  Package with blocks that convert between the signal connectors of
  <a href=\"modelica://BrineGrid.Fluid.FMI.Interfaces\">
  BrineGrid.Fluid.FMI.Interfaces</a>
...
<p>
The package
<a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs\">
BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs</a>
...
<p>
In the
<a href=\"modelica://BrineGrid.Fluid\">BrineGrid.Fluid</a> package,
...
<a href=\"modelica://BrineGrid.Fluid.FMI\">BrineGrid.Fluid.FMI</a> package.
...
flow rate, such as
<a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow\">
BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow</a>.
</p>
<h4>Notes</h4>
<p>
...
<a href=\"modelica://BrineGrid.Media.Air\">
BrineGrid.Media.Air</a>.
...
<p>
For <a href=\"modelica://BrineGrid.Media.Water\">
BrineGrid.Media.Water</a>, this setting is not needed
...
<p>
The model
<a href=\"modelica://BrineGrid.Fluid.FixedResistances.FlowMachine_m_flow\">
BrineGrid.Fluid.FixedResistances.FlowMachine_m_flow</a>
...
do so by using
<a href=\"modelica://BrineGrid.Fluid.FMI.IdealSource_m_flow\">
BrineGrid.Fluid.FMI.IdealSource_m_flow</a>,
...
<a href=\"modelica://BrineGrid.Fluid.FixedResistances.PressureDrop\">
BrineGrid.Fluid.FixedResistances.PressureDrop</a>
...
<a href=\"modelica://BrineGrid/Resources/Images/Fluid/FMI/UsersGuide/2015-WetterFuchsNouidui.pdf\">
