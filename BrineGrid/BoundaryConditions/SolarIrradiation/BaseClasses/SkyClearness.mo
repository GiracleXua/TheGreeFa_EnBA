within BrineGrid.BoundaryConditions.SolarIrradiation.BaseClasses;
...
equation
  tmp1 =  k*zen^3;
  HDifHorBou = BrineGrid.Utilities.Math.Functions.smoothMax(
                 x1 = HDifHor,
                 x2 = hSmall,
                 deltaX = deltaX);
  ...
  skyCle = BrineGrid.Utilities.Math.Functions.smoothLimit(
...
<p>
In the <code>BrineGrid</code> library, <code>HGloHor</code>
...
<p>
The function call
<code>BrineGrid.Utilities.Math.Functions.smoothMax</code>
