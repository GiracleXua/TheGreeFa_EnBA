...
model Density_pTX "Model to test the density computation"
 ...
 package Medium = BrineGrid.Media.Air "Medium model"
  ...
  BrineGrid.Utilities.Psychrometrics.Density_pTX den "Density"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Density_pTX.mos"
        "Simulate and plot"),
