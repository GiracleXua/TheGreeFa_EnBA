within BrineGrid.BoundaryConditions.SkyTemperature.Examples;
model BlackBody "Test model for black body sky temperature"
  ...
  BrineGrid.BoundaryConditions.SkyTemperature.BlackBody TBlaSky
  ...
  BrineGrid.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
      ...
      Placement(transformation(extent={{0,0},{20,20}}), iconTransformation(
          extent={{0,0},{2,2}})));
  BrineGrid.BoundaryConditions.SkyTemperature.BlackBody TBlaSkyIrr(calTSky=
        BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation)
...
experiment(StopTime=86400),
    __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SkyTemperature/Examples/BlackBody.mos"
        "Simulate and plot"),
