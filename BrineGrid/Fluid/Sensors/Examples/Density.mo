...
model Density "Test model for the density sensor"
  ...
  BrineGrid.Fluid.Sensors.Density senDenVol(
  ...
  BrineGrid.Fluid.Sensors.DensityTwoPort senDenFlo(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Density.mos"
        "Simulate and plot"),
