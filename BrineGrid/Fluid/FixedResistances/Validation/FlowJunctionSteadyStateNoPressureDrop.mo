...
model FlowJunctionSteadyStateNoPressureDrop
 ...
 package Medium = BrineGrid.Media.Air "Medium model";
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T bou1(
    redeclare package Medium = Medium,
    T=273.15 + 10,
    nPorts=1,
  ...
  BrineGrid.Fluid.Sources.Boundary_pT bou2(
    redeclare package Medium = Medium,
    T=273.15 + 20,
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T bou3(
    redeclare package Medium = Medium,
    T=273.15 + 30,
    nPorts=1,
    use_m_flow_in=true) "Mass flow boundary condition"
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem1(
    redeclare package Medium = Medium,
    m_flow_nominal=1) "Temperature sensor"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));

  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem2(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Temperature sensor"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));

  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem3(
    redeclare package Medium = Medium,
    m_flow_nominal=3) "Temperature sensor"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/FlowJunctionSteadyStateNoPressureDrop.mos"
        "Simulate and plot"),
