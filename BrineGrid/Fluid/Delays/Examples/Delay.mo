...
// that is used in this model.
 package Medium = BrineGrid.Media.Air(X_default={0.001, 0.999});
  ...
  BrineGrid.Fluid.Delays.DelayFirstOrder del(         m_flow_nominal=5, redeclare
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Delays/Examples/Delay.mos"
        "Simulate and plot"));
end Delay;
