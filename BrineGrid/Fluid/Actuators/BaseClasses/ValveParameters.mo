within BrineGrid.Fluid.Actuators.BaseClasses;
partial model ValveParameters "Model with parameters for valves"

  parameter BrineGrid.Fluid.Types.CvTypes CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint
    "Selection of flow coefficient"
   annotation(Dialog(group = "Flow Coefficient"));
  parameter Real Kv(
    fixed= if CvData==BrineGrid.Fluid.Types.CvTypes.Kv then true else false)
    "Kv (metric) flow coefficient [m3/h/(bar)^(1/2)]"
  annotation(Dialog(group = "Flow Coefficient",
                    enable = (CvData==BrineGrid.Fluid.Types.CvTypes.Kv)));
  parameter Real Cv(
    fixed= if CvData==BrineGrid.Fluid.Types.CvTypes.Cv then true else false)
    "Cv (US) flow coefficient [USG/min/(psi)^(1/2)]"
  annotation(Dialog(group = "Flow Coefficient",
                    enable = (CvData==BrineGrid.Fluid.Types.CvTypes.Cv)));
  parameter Modelica.SIunits.Area Av(
    fixed= if CvData==BrineGrid.Fluid.Types.CvTypes.Av then true else false)
    "Av (metric) flow coefficient"
   annotation(Dialog(group = "Flow Coefficient",
                     enable = (CvData==BrineGrid.Fluid.Types.CvTypes.Av)));
  ...
  parameter Modelica.SIunits.PressureDifference dpValve_nominal(
     displayUnit="Pa",
     min=0,
     fixed= if CvData==BrineGrid.Fluid.Types.CvTypes.OpPoint then true else false)
    "Nominal pressure drop of fully open valve, used if CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint"
    annotation(Dialog(group="Nominal condition",
               enable = (CvData==BrineGrid.Fluid.Types.CvTypes.OpPoint)));
...
protected
  ...
  annotation(Dialog(group = "Flow Coefficient",
                    enable = (CvData==BrineGrid.Fluid.Types.CvTypes.OpPoint)));
initial equation
  if  CvData == BrineGrid.Fluid.Types.CvTypes.OpPoint then
  ...
  elseif CvData == BrineGrid.Fluid.Types.CvTypes.Cv then
    ...
    assert(CvData == BrineGrid.Fluid.Types.CvTypes.Av, "Invalid value for CvData.
...
<ul>
<li><code>CvData = BrineGrid.Fluid.Types.CvTypes.Av</code>: the flow coefficient is given by the metric <code>Av</code> coefficient (m^2).</li>
<li><code>CvData = BrineGrid.Fluid.Types.CvTypes.Kv</code>: the flow coefficient is given by the metric <code>Kv</code> coefficient (m^3/h).</li>
<li><code>CvData = BrineGrid.Fluid.Types.CvTypes.Cv</code>: the flow coefficient is given by the US <code>Cv</code> coefficient (USG/min).</li>
<li><code>CvData = BrineGrid.Fluid.Types.CvTypes.OpPoint</code>: the flow is computed from the nominal operating point specified by <code>dp_nominal</code> and <code>m_flow_nominal</code>.</li>
</ul>
<p>
...
<code>Kv</code>,
<code>Cv</code>, or, if
<code>CvData = BrineGrid.Fluid.Types.CvTypes.OpPoint</code>, based on
<code>m_flow_nominal</code> and <code>dpValve_nominal</code>.
Conversely, if
<code>CvData &lt;&gt; BrineGrid.Fluid.Types.CvTypes.OpPoint</code>, then
<code>dpValve_nominal</code> is computed based on
<code>Av</code>,
<code>Kv</code>, or
<code>Cv</code>, and the nominal mass flow rate <code>m_flow_nominal</code>.
Therefore, if
<code>CvData &lt;&gt; BrineGrid.Fluid.Types.CvTypes.OpPoint</code>,
...
<a href=\"modelica://BrineGrid.Fluid.Actuators.Valves.Examples.TwoWayValveTable\">
BrineGrid.Fluid.Actuators.Valves.Examples.TwoWayValveTable</a>,
