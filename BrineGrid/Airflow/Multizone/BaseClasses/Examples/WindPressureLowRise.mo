...
equation
  ...
  Cp = BrineGrid.Airflow.Multizone.BaseClasses.windPressureLowRise(
    Cp0=Cp0,
    G=G,
    incAng=incAng);
  annotation (
experiment(StartTime=-2, StopTime=2),
  __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/WindPressureLowRise.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This examples demonstrates the
<a href=\"modelica://BrineGrid.Airflow.Multizone.BaseClasses.windPressureLowRise\">
BrineGrid.Airflow.Multizone.BaseClasses.windPressureLowRise</a>
function.
</p>
</html>", revisions="<html>
<ul>
