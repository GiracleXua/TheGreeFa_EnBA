within BrineGrid.Fluid.FMI.Interfaces;
connector Outlet "Connector for fluid outlet"
  ...
  BrineGrid.Fluid.FMI.Interfaces.PressureOutput p if use_p_in
    "Thermodynamic pressure in the connection point";

  input BrineGrid.Fluid.FMI.Interfaces.FluidProperties backward(
    redeclare final package Medium = Medium) if allowFlowReversal
    "Inflowing properties";

  output BrineGrid.Fluid.FMI.Interfaces.FluidProperties forward(
