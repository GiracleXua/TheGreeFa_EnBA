...
equation
  y = BrineGrid.Utilities.Math.Functions.smoothHeaviside(x=u, delta=delta);
...
See Example <a href=\"modelica://BrineGrid.Utilities.Math.Examples.SmoothHeaviside\">
BrineGrid.Utilities.Math.Examples.SmoothHeaviside</a>.
</p>
</html>",
revisions="<html>
<ul>
