within BrineGrid.Fluid.Chillers.Validation;
...
protected
  model Chiller "Subsystem model with the chiller"
   ...
   replaceable package Medium2 = Modelica.Media.Interfaces.PartialMedium
    ...
    BrineGrid.Fluid.Sources.MassFlowSource_T sou1(
    ...
    BrineGrid.Fluid.Sources.FixedBoundary sin1(redeclare package Medium = Medium2, nPorts=1)
      "Pressure source" annotation (Placement(transformation(extent={{-10,-10},{
              10,10}}, origin={-88,-50})));
    BrineGrid.Fluid.Chillers.Carnot_TEva chi(
    ...
    BrineGrid.Fluid.Sources.MassFlowSource_T sou2(
    ...
    BrineGrid.Fluid.Sensors.EntropyFlowRate S_a1(
      redeclare package Medium = Medium1,
      m_flow_nominal=m1_flow_nominal,
      tau=0) "Entropy flow rate sensor"
      annotation (Placement(transformation(extent={{-50,-20},{-30,0}})));
    BrineGrid.Fluid.Sensors.EntropyFlowRate S_a2(
      redeclare package Medium = Medium1,
      m_flow_nominal=m1_flow_nominal,
      tau=0) "Entropy flow rate sensor"
      annotation (Placement(transformation(extent={{-30,-60},{-50,-40}})));
    BrineGrid.Fluid.Sensors.EntropyFlowRate S_a3(
      redeclare package Medium = Medium1,
      m_flow_nominal=m1_flow_nominal,
      tau=0) "Entropy flow rate sensor"
      annotation (Placement(transformation(extent={{58,-60},{38,-40}})));
    BrineGrid.Fluid.Sensors.EntropyFlowRate S_a4(
      redeclare package Medium = Medium1,
      m_flow_nominal=m1_flow_nominal,
      tau=0) "Entropy flow rate sensor"
      annotation (Placement(transformation(extent={{38,-20},{58,0}})));
    BrineGrid.Fluid.Sources.FixedBoundary sin2(redeclare package Medium = Medium2, nPorts=1)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_2ndLaw.mos"
        "Simulate and plot"),
