within BrineGrid.Fluid.Sources.BaseClasses;
partial model Outside
  ...
  BrineGrid.BoundaryConditions.WeatherData.Bus weaBus "Bus with weather data"
...
protected
  ...
  BrineGrid.Utilities.Psychrometrics.X_pTphi x_pTphi if not singleSubstance
