...
model DiffuseIsotropic
  ...
  BrineGrid.BoundaryConditions.SolarIrradiation.BaseClasses.DiffuseIsotropic
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/DiffuseIsotropic.mos"
        "Simulate and plot"));
