...
function SherwoodNumber_rho1 "Return Sherwood number from beta, L, rho and D"
  extends Modelica.Icons.Function;
  input BrineGrid.SIunits.CoefficientOfMassTransfer2 beta
