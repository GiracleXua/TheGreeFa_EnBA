...
model MixingVolumeInitialization "Test model for mixing volume initialization"
 ...
 package Medium = BrineGrid.Media.Air;
  ...
  BrineGrid.Fluid.Sources.Boundary_pT sou1(redeclare package Medium =
        Medium,
    p=101330,
    nPorts=1,
    T=293.15)                                       annotation (Placement(
        transformation(extent={{-60,10},{-40,30}})));
  BrineGrid.Fluid.Sources.Boundary_pT sin1(redeclare package Medium =
        Medium,
    p=101320,
    nPorts=1,
    T=293.15)                                       annotation (Placement(
...
experiment(StopTime=0.001,
           Tolerance=1e-6),
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeInitialization.mos"
        "Simulate and plot"),
