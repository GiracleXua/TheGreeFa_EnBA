...
model FlowControlled_dp
  ...
  extends BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine(
    final preVar=BrineGrid.Fluid.Movers.BaseClasses.Types.PrescribedVariable.PressureDifference,
    ...
    eff(
      per(
        final pressure = if per.havePressureCurve then
          ...
          BrineGrid.Fluid.Movers.BaseClasses.Characteristics.flowParameters(
  ...
  parameter Modelica.SIunits.PressureDifference constantHead(
    ...
    annotation(Dialog(enable=inputType == BrineGrid.Fluid.Types.InputType.Constant));
  ...
  parameter Modelica.SIunits.PressureDifference[:] heads(
    ...
    annotation(Dialog(enable=inputType == BrineGrid.Fluid.Types.InputType.Stages));

  Modelica.Blocks.Interfaces.RealInput dp_in(final unit="Pa") if inputType ==
    BrineGrid_test.Fluid.Types.InputType.Continuous
...
<a href=\"modelica://BrineGrid.Fluid.Movers.Data.SpeedControlled_y\">
BrineGrid.Fluid.Movers.Data.SpeedControlled_y</a>
as it makes sense to use it for the movers
<a href=\"modelica://BrineGrid.Fluid.Movers.FlowControlled_Nrpm\">
BrineGrid.Fluid.Movers.FlowControlled_Nrpm</a>
and
<a href=\"modelica://BrineGrid.Fluid.Movers.FlowControlled_y\">
BrineGrid.Fluid.Movers.FlowControlled_y</a>.<br/>
This is for
...
<li>October 1, 2009,
    by Michael Wetter:<br/>
       Added model to the BrineGrid library.
</ul>
</html>"),
    Icon(graphics={
        Text(
