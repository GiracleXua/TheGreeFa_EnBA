...
block HeaterCooler_u
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed heat flow rate"
   extends BrineGrid.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BrineGrid.Fluid.HeatExchangers.HeaterCooler_u com(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
