...
algorithm
  cor :=deltaX/10;
  y := BrineGrid.Utilities.Math.Functions.smoothMax(x,l+deltaX,cor);
  y := BrineGrid.Utilities.Math.Functions.smoothMin(y,u-deltaX,cor);
...
<a href=\"modelica://BrineGrid.Utilities.Math.Examples.SmoothMin\">
BrineGrid.Utilities.Math.Examples.SmoothMin</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
