...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_y_etaPL.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example extends from
<a href=\"modelica://BrineGrid.Fluid.Chillers.Examples.Carnot_y\">
BrineGrid.Fluid.Chillers.Examples.Carnot_y</a>
