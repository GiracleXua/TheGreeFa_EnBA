within BrineGrid.Fluid.FixedResistances.Examples;
model FlowJunction
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/FlowJunction.mos"
        "Simulate and plot"),
