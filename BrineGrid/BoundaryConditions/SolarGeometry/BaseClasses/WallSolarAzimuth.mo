within BrineGrid.BoundaryConditions.SolarGeometry.BaseClasses;
...
equation
  alt_c=Modelica.Math.cos(BrineGrid.Utilities.Math.Functions.smoothLimit(
  ...
  verAzi=Modelica.Math.acos(
       BrineGrid.Utilities.Math.Functions.smoothLimit(x=rat, l=-1+deltaX, u=1-deltaX, deltaX=deltaX/10));

  annotation (Icon(graphics={Bitmap(extent={{-92,92},{92,-92}}, fileName=
              "modelica://BrineGrid/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/WallSolarAzimuth.png")}),
...
<a href=\"modelica://BrineGrid.HeatTransfer.Windows.BaseClasses.Examples.Overhang\">
BrineGrid.HeatTransfer.Windows.BaseClasses.Examples.Overhang</a>.
</li>
<li>
