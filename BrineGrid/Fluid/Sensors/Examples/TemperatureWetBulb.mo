...
model TemperatureWetBulb "Test model for the wet bulb temperature sensor"
 ...
 package Medium = BrineGrid.Media.Air "Medium model"
  ...
  BrineGrid.Fluid.Sensors.TemperatureWetBulbTwoPort senWetBul(
    redeclare package Medium=Medium,
    m_flow_nominal=1,
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/TemperatureWetBulb.mos"
        "Simulate and plot"),
