within BrineGrid.Fluid.FMI.ExportContainers;
block ReplaceableTwoPort
  "Container to export thermofluid flow models with two ports as an FMU"
  extends BrineGrid.Fluid.FMI.ExportContainers.PartialTwoPort;
  replaceable BrineGrid.Fluid.Interfaces.PartialTwoPort com
    constrainedby BrineGrid.Fluid.Interfaces.PartialTwoPort(
...
protected
  BrineGrid.Fluid.FMI.Adaptors.Inlet bouIn(
    redeclare final package Medium=Medium,
    final allowFlowReversal=allowFlowReversal,
    final use_p_in=use_p_in) "Boundary model for inlet"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));

  BrineGrid.Fluid.FMI.Adaptors.Outlet bouOut(
    redeclare final package Medium=Medium,
    final allowFlowReversal=allowFlowReversal,
...
<a href=\"modelica://BrineGrid.Fluid.Interfaces.PartialTwoPort\">
BrineGrid.Fluid.Interfaces.PartialTwoPort</a>.
This allows exporting a large variety of thermofluid flow models
with a simple redeclare.
</p>
<p>
See for example
<a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.PressureDrop\">
BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.PressureDrop</a>
or
<a href=\"modelica://BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HeaterCooler_u\">
BrineGrid.Fluid.FMI.ExportContainers.Examples.FMUs.HeaterCooler_u</a>
...
together with
<a href=\"modelica://BrineGrid.Fluid.FMI.InletAdaptor\">
BrineGrid.Fluid.FMI.InletAdaptor</a>
and
<a href=\"modelica://BrineGrid.Fluid.FMI.OutletAdaptor\">
BrineGrid.Fluid.FMI.OutletAdaptor</a>
