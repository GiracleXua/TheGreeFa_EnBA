within BrineGrid.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  parameter BrineGrid.BoundaryConditions.Types.DataSource pAtmSou=BrineGrid.BoundaryConditions.Types.DataSource.Parameter
    "Atmospheric pressure"
  ...
  Modelica.Blocks.Interfaces.RealInput pAtm_in(
    ...
    final unit="Pa",
    displayUnit="Pa") if (pAtmSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input pressure"
    annotation (Placement(transformation(extent={{-240,254},{-200,294}}),
        iconTransformation(extent={{-240,254},{-200,294}})));
  //--------------------------------------------------------------
  // Ceiling height
  parameter BrineGrid.BoundaryConditions.Types.DataSource ceiHeiSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput ceiHei_in(
    final quantity="Height",
    final unit="m",
    displayUnit="m") if (ceiHeiSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input ceiling height"
    annotation (Placement(transformation(extent={{-242,-14},{-202,26}}),
        iconTransformation(extent={{-242,-14},{-202,26}})));
  //--------------------------------------------------------------
  // Total sky cover
  parameter BrineGrid.BoundaryConditions.Types.DataSource totSkyCovSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput totSkyCov_in(
    min=0,
    max=1,
    unit="1") if (totSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input total sky cover"
    annotation (Placement(transformation(extent={{-240,-58},{-200,-18}}),
        iconTransformation(extent={{-240,-58},{-200,-18}})));
  // Opaque sky cover
  parameter BrineGrid.BoundaryConditions.Types.DataSource opaSkyCovSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput opaSkyCov_in(
    min=0,
    max=1,
    unit="1") if (opaSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
  ...
  parameter BrineGrid.BoundaryConditions.Types.DataSource TDryBulSou=BrineGrid.BoundaryConditions.Types.DataSource.File
    "Dry bulb temperature"
    annotation (Evaluate=true, Dialog(group="Data source"));
  ...
  Modelica.Blocks.Interfaces.RealInput TDryBul_in(
    ...
    final unit="K",
    displayUnit="degC") if (TDryBulSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input dry bulb temperature"
    annotation (Placement(transformation(extent={{-240,160},{-200,200}})));

  //--------------------------------------------------------------
  // Dew point temperature
  parameter BrineGrid.BoundaryConditions.Types.DataSource TDewPoiSou=BrineGrid.BoundaryConditions.Types.DataSource.File
    "Dew point temperature"
    annotation (Evaluate=true, Dialog(group="Data source"));
  ...
  Modelica.Blocks.Interfaces.RealInput TDewPoi_in(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC") if (TDewPoiSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input dew point temperature"
    annotation (Placement(transformation(extent={{-240,204},{-200,244}})));

  //--------------------------------------------------------------
  // Black body sky temperature
  parameter BrineGrid.BoundaryConditions.Types.DataSource TBlaSkySou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput TBlaSky_in(
    ...
    displayUnit="degC",
    final unit="K") if
    (TBlaSkySou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Black-body sky temperature"
    annotation (Placement(transformation(extent={{-240,120},{-200,160}}),
        iconTransformation(extent={{-240,120},{-200,160}})));
  //--------------------------------------------------------------
  // Relative humidity
  parameter BrineGrid.BoundaryConditions.Types.DataSource relHumSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput relHum_in(
    min=0,
    max=1,
    unit="1") if (relHumSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input relative humidity"
    annotation (Placement(transformation(extent={{-240,80},{-200,120}}),
        iconTransformation(extent={{-240,80},{-200,120}})));
  //--------------------------------------------------------------
  // Wind speed
  parameter BrineGrid.BoundaryConditions.Types.DataSource winSpeSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput winSpe_in(
    ...
    final unit="m/s",
    min=0) if (winSpeSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input wind speed"
    annotation (Placement(transformation(extent={{-240,-98},{-200,-58}}),
        iconTransformation(extent={{-240,-98},{-200,-58}})));
  //--------------------------------------------------------------
  // Wind direction
  parameter BrineGrid.BoundaryConditions.Types.DataSource winDirSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput winDir_in(
    ...
    final unit="rad",
    displayUnit="deg") if (winDirSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
    "Input wind direction"
    annotation (Placement(transformation(extent={{-240,-140},{-200,-100}}),
        iconTransformation(extent={{-240,-140},{-200,-100}})));
  //--------------------------------------------------------------
  // Infrared horizontal radiation
  parameter BrineGrid.BoundaryConditions.Types.DataSource HInfHorSou=BrineGrid.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput HInfHor_in(
    ...
    final unit="W/m2") if (HInfHorSou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
   ...
   parameter BrineGrid.BoundaryConditions.Types.RadiationDataSource HSou=BrineGrid.BoundaryConditions.Types.RadiationDataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2") if
                          (HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
  ...
  final parameter Modelica.SIunits.Angle lon(displayUnit="deg")=
    BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(
    absFilNam) "Longitude";
  final parameter Modelica.SIunits.Angle lat(displayUnit="deg")=
    BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(
    absFilNam) "Latitude";
  final parameter Modelica.SIunits.Time timZon(displayUnit="h")=
    BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getTimeZoneTMY3(absFilNam)
    "Time zone";
  ...
  parameter BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation
    calTSky=BrineGrid.BoundaryConditions.Types.SkyTemperatureCalculation.TemperaturesAndSkyCover
...
protected
  final parameter String absFilNam = BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath(filNam)
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckTemperature
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky) if
       not (TBlaSkySou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter or
            TBlaSkySou == BrineGrid.BoundaryConditions.Types.DataSource.Input)
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.LocalCivilTime locTim(
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.ConvertTime conTim1
  ...
  BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulPhi tWetBul_TDryBulXi(
  ...
  Modelica.Blocks.Math.Gain conTotSkyCov(final k=0.1) if
       totSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{120,-40},{140,-20}})));
  Modelica.Blocks.Math.Gain conOpaSkyCov(final k=0.1) if
       opaSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{120,-158},{140,-138}})));
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckBlackBodySkyTemperature cheTemBlaSky(TMin=0)
...
equation
  ...
  if pAtmSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    pAtm_in_internal = pAtm;
  elseif pAtmSou == BrineGrid.BoundaryConditions.Types.DataSource.File then
  ...
  if ceiHeiSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    ceiHei_in_internal = ceiHei;
  elseif ceiHeiSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if totSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    totSkyCov_in_internal = totSkyCov;
  elseif totSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if opaSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    opaSkyCov_in_internal = opaSkyCov;
  elseif opaSkyCovSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDewPoiSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    TDewPoi_in_internal = TDewPoi;
  elseif TDewPoiSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDryBulSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    TDryBul_in_internal = TDryBul;
  elseif TDryBulSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if TBlaSkySou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    TBlaSky_in_internal = TBlaSky;
  elseif TBlaSkySou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if relHumSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    relHum_in_internal = relHum;
  elseif relHumSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if winSpeSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    winSpe_in_internal = winSpe;
  elseif winSpeSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if winDirSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    winDir_in_internal = winDir;
  elseif winDirSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  if HSou ==  BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
    connect(HGloHor_in, HGloHor_in_internal)
      "Get HGloHor using user input file";
  elseif HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDifHor_in, HDifHor_in_internal)
      "Get HDifHor using user input file";
  elseif  HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
  ...
  if HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDirNor_in, HDirNor_in_internal)
      "Get HDirNor using user input file";
  elseif  HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor then
      BrineGrid.Utilities.Math.Functions.smoothMin(
        solCon,
        (HGloHor_in_internal -HDifHor_in_internal)*
          BrineGrid.Utilities.Math.Functions.spliceFunction(
            x=cos(zenAng.zen),
            pos=BrineGrid.Utilities.Math.Functions.inverseXRegularized(cos(zenAng.zen),epsCos),
            neg=0,
            deltax=epsCos),
        0.1)
        = HDirNor_in_internal
  ...
  if HInfHorSou == BrineGrid.BoundaryConditions.Types.DataSource.Parameter then
    HInfHor_in_internal = HInfHor;
  elseif HInfHorSou == BrineGrid.BoundaryConditions.Types.DataSource.Input then
  ...
  annotation (
    ...
    Icon(coordinateSystem(
        ...
        Text(
          ...
          lineColor={0,0,255}),
        Text(
          visible=(pAtmSou == BrineGrid.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,216},{-164,184}},
          lineColor={0,0,127},
          textString="p"),
        Text(
          visible=(TDryBulSou == BrineGrid.BoundaryConditions.Types.DataSource.Input),
          extent={{-194,162},{-118,118}},
          lineColor={0,0,127},
          textString="TDryBul"),
        Text(
          visible=(relHumSou == BrineGrid.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,92},{-104,66}},
          lineColor={0,0,127},
          textString="relHum"),
        Text(
        visible=(winSpeSou == BrineGrid.BoundaryConditions.Types.DataSource.Input),
          extent={{-196,44},{-110,2}},
          lineColor={0,0,127},
          textString="winSpe"),
        Text(
          visible=(winDirSou == BrineGrid.BoundaryConditions.Types.DataSource.Input),
          extent={{-192,-18},{-106,-60}},
          lineColor={0,0,127},
          textString="winDir"),
        Text(
        visible=(HSou ==  BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor),
        extent={{-202,-88},{-112,-108}},
          lineColor={0,0,127},
          textString="HGloHor"),
        Text(visible=(HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
        extent={{-202,-142},{-116,-164}},
          lineColor={0,0,127},
          textString="HDifHor"),
        Text(
        visible=(HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == BrineGrid.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
...
<li>
Add the file to <code>BrineGrid/Resources/weatherdata</code> (or to any directory
for which you have write permission).
</li>
<li>
On a console window, type<pre>
  cd BrineGrid/Resources/weatherdata
...
by the model
<a href=\"modelica://BrineGrid.BoundaryConditions.WeatherData.ReaderTMY3\">
BrineGrid.BoundaryConditions.WeatherData.ReaderTMY3</a>.
</li>
</ol>
<!-- ============================================== -->
...
the enumeration
<a href=\"modelica://BrineGrid.BoundaryConditions.Types.DataSource\">
BrineGrid.BoundaryConditions.Types.DataSource</a>
is used as follows:
</p>
<table summary=\"summary\" border=\"1\" cellspacing=\"0\" cellpadding=\"2\" style=\"border-collapse:collapse;\">
<!-- ============================================== -->
...
<a href=\"modelica://BrineGrid.BoundaryConditions.Types.RadiationDataSource\">
BrineGrid.BoundaryConditions.Types.RadiationDataSource</a>,
...
the weather data files in the BrineGrid library do not use the data entry from
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/BoundaryConditions/WeatherData/RadiationTimeShift.png\"
border=\"1\" />
</p>
<h4>References</h4>
<ul>
...
<a href=modelica://BrineGrid.BoundaryConditions.SkyTemperature.Examples.BlackBody>TBlaSky</a> 
are consistent.
This is for
...
<a href=\"modelica://BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath\">
BrineGrid.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath</a>.
This is for
...
<a href=\"modelica://BrineGrid.BoundaryConditions.SolarIrradiation.BaseClasses.Examples.SkyClearness\">
BrineGrid.BoundaryConditions.SolarIrradiation.BaseClasses.Examples.SkyClearness</a>
...
<code>file://</code>, <code>modelica://</code> and <code>modelica://BrineGrid</code>
...
as long as the <code>BrineGrid</code> library
