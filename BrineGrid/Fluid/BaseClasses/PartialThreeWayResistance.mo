...
partial model PartialThreeWayResistance
  ...
  replaceable BrineGrid.Fluid.Interfaces.PartialTwoPortInterface res1
    constrainedby BrineGrid.Fluid.Interfaces.PartialTwoPortInterface(
  ...
  replaceable BrineGrid.Fluid.Interfaces.PartialTwoPortInterface res2
    constrainedby BrineGrid.Fluid.Interfaces.PartialTwoPortInterface(
      redeclare final package Medium = Medium,
      allowFlowReversal=portFlowDirection_2 == Modelica.Fluid.Types.PortFlowDirection.Bidirectional)
    "Partial model, to be replaced with a fluid component"
    annotation (Placement(transformation(extent={{60,-10},{40,10}})));
  replaceable BrineGrid.Fluid.Interfaces.PartialTwoPortInterface res3
    constrainedby BrineGrid.Fluid.Interfaces.PartialTwoPortInterface(
      redeclare final package Medium = Medium,
  ...
  BrineGrid.Fluid.Delays.DelayFirstOrder vol(
    ...
    final prescribedHeatFlowRate=false) if have_controlVolume
...
<code>BrineGrid.Fluid.Examples.ResistanceVolumeFlowReversal</code> fails to simulate.
</li>
<li>
