within BrineGrid.Utilities.Math;
block IntegratorWithReset "Output the integral of the input signal"
  ...
  */
  ...
  parameter BrineGrid.Types.Reset reset = BrineGrid.Types.Reset.Disabled
    "Type of integrator reset";

  parameter Real y_reset = 0
    "Value to which integrator is reset, used if reset = BrineGrid.Types.Reset.Parameter"
    annotation(Evaluate=true,
               Dialog(
                 enable=reset == BrineGrid.Types.Reset.Parameter,
                 group="Integrator reset"));

  Modelica.Blocks.Interfaces.RealInput y_reset_in if
       reset == BrineGrid.Types.Reset.Input
    "Input signal for state to which integrator is reset, enabled if reset = BrineGrid.Types.Reset.Input"
    annotation (Placement(transformation(extent={{-140,-100},{-100,-60}})));

  Modelica.Blocks.Interfaces.BooleanInput trigger if
       reset <> BrineGrid.Types.Reset.Disabled
...
equation
  ...
  if reset <> BrineGrid.Types.Reset.Input then
    y_reset_internal = y_reset;
  end if;

  if reset == BrineGrid.Types.Reset.Disabled then
...
<ul>
<li>
If <code>reset = BrineGrid.Types.Reset.Disabled</code>, which is the default,
then the integrator is never reset.
</li>
<li>
If <code>reset = BrineGrid.Types.Reset.Parameter</code>, then a boolean
...
<li>
If <code>reset = BrineGrid.Types.Reset.Input</code>, then a boolean
input signal <code>trigger</code> is enabled. Whenever the value of
this input changes from <code>false</code> to <code>true</code>,
the integrator is reset by setting <code>y</code>
...
<p>
See <a href=\"modelica://BrineGrid.Utilities.Math.Examples.IntegratorWithReset\">
BrineGrid.Utilities.Math.Examples.IntegratorWithReset</a> for an example.
</p>
...
Icon(coordinateSystem(
        ...
        graphics={
          ...
          visible=reset == BrineGrid.Types.Reset.Input,
          horizontalAlignment=TextAlignment.Left),
        Bitmap(extent={{-54,-50},{60,50}}, fileName=
              "modelica://BrineGrid/Resources/Images/Utilities/Math/int.png"),
          Text(
            extent={{-88,56},{206,92}},
          lineColor={0,0,0},
          textString="k=%k",
