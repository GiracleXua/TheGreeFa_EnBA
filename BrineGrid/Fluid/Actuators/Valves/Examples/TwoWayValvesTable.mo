...
model TwoWayValvesTable "Two way valve with linear opening characteristics"
  ...
  Valves.TwoWayTable valTab(
    ...
    flowCharacteristics=BrineGrid.Fluid.Actuators.Valves.Data.Linear(),
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValvesTable.mos"
        "Simulate and plot"),
