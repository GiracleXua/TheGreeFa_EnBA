...
equation
  ...
  // in BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2
  dp = 1*time^3;
...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-08),
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/BasicFlowFunction_dp_DerivativeCheck2.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This model validates the implementation of
<a href=\"modelica://BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">
BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a>
and its second order derivative
<a href=\"modelica://BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2\">
BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2</a>.
