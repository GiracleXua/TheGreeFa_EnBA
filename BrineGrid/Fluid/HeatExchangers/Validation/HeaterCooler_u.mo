...
model HeaterCooler_u "Model that demonstrates the ideal heater model"
  ...
  BrineGrid.Fluid.HeatExchangers.HeaterCooler_u heaSte(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Controls.Continuous.LimPID con1(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    Td=1,
    k=1,
    Ti=10) "Controller"
    annotation (Placement(transformation(extent={{40,140},{60,160}})));
  BrineGrid.Fluid.HeatExchangers.HeaterCooler_u heaDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    Q_flow_nominal=3000,
  ...
  BrineGrid.Controls.Continuous.LimPID con2(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    Td=1,
    Ti=10,
    k=0.1) "Controller"
...
equation
  ...
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{200,
            200}}), graphics),
    __Dymola_Commands(file= "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/HeaterCooler_u.mos" "Simulate and plot"),
