...
model FourPortHeatMassExchanger
  ...
  extends BrineGrid.Fluid.Interfaces.PartialFourPortInterface(
  ...
  extends BrineGrid.Fluid.Interfaces.FourPortFlowResistanceParameters(
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume vol1(
  ...
  replaceable BrineGrid.Fluid.MixingVolumes.MixingVolume vol2
    constrainedby BrineGrid.Fluid.MixingVolumes.BaseClasses.PartialMixingVolume(
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop preDro1(
    redeclare final package Medium = Medium1,
    final m_flow_nominal=m1_flow_nominal,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop preDro2(
    redeclare final package Medium = Medium2,
    final m_flow_nominal=m2_flow_nominal,
...
See for example
<a href=\"BrineGrid.Fluid.Chillers.Carnot_y\">
BrineGrid.Fluid.Chillers.Carnot_y</a>.
