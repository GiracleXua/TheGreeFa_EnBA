within BrineGrid.Fluid.Sensors.Conversions.Examples;
model To_VolumeFraction "Example problem for conversion model"
  ...
  BrineGrid.Fluid.Sensors.Conversions.To_VolumeFraction conMasVolFra(MMMea=
  ...
  BrineGrid.Controls.Continuous.LimPID limPID(
  ...
  BrineGrid.Fluid.Sensors.TraceSubstances senCO2(redeclare package Medium =
  ...
  BrineGrid.Fluid.Sources.TraceSubstancesFlowSource souCO2(
    use_m_flow_in=true,
    redeclare package Medium = Medium,
    nPorts=1) "CO2 source"
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sin(
    redeclare package Medium = Medium,
    p=100000,
    C={300E-6}*44.009544/28.9651159,
  ...
  BrineGrid.Fluid.Sensors.VolumeFlowRate senVolFlo(redeclare package Medium =
  ...
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(m_flow_nominal=0.1,
      redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
    "CO2 concentration in absorptance from people"
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  BrineGrid.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(m_flow_nominal=0.1,
      redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Conversions/Examples/To_VolumeFraction.mos"
        "Simulate and plot"),
