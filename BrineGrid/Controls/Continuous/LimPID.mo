within BrineGrid.Controls.Continuous;
block LimPID
  ...
  parameter Real y_reset=xi_start
    "Value to which the controller output is reset if the boolean trigger has a rising edge, used if reset == BrineGrid.Types.Reset.Parameter"
    annotation(Dialog(enable=reset == BrineGrid.Types.Reset.Parameter,
  ...
  Utilities.Math.IntegratorWithReset I(
    final reset=if reset == BrineGrid.Types.Reset.Disabled then reset else BrineGrid.Types.Reset.Input,
...
<code>reset = BrineGrid.Types.Reset.Disabled</code> is sufficient.
