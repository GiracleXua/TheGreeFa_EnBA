within BrineGrid.Fluid.MassExchangers.Examples;
model Humidifier_u "Model that demonstrates the ideal humidifier model"
  ...
  BrineGrid.Fluid.MassExchangers.Humidifier_u humSte(
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem1(redeclare package Medium =
  ...
  BrineGrid.Fluid.MassExchangers.Humidifier_u humDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    mWat_flow_nominal=m_flow_nominal*0.005,
  ...
  BrineGrid.Fluid.Sensors.TemperatureTwoPort senTem2(redeclare package Medium =
        Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/MassExchangers/Examples/Humidifier_u.mos"
        "Simulate and plot"),
