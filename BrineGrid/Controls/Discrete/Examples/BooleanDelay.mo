within BrineGrid.Controls.Discrete.Examples;
model BooleanDelay "Example model for boolean delay"
  extends Modelica.Icons.Example;
  BrineGrid.Controls.Discrete.BooleanDelay del(samplePeriod=0.05)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Controls/Discrete/Examples/BooleanDelay.mos"
        "Simulate and plot"),
