...
model PressureDropsParallel
 ...
 package Medium = BrineGrid.Media.Water "Medium model";
  ...
  BrineGrid.Fluid.Sources.Boundary_pT sou1(
    redeclare package Medium = Medium,
    nPorts=2,
    use_p_in=true,
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFlo2(redeclare package Medium = Medium)
    "Mass flow rate sensor" annotation (Placement(transformation(extent={{0,-10},
            {20,10}})));
  BrineGrid.Utilities.Diagnostics.AssertEquality assEqu(
  ...
  BrineGrid.Fluid.Sensors.MassFlowRate masFlo1(redeclare package Medium = Medium)
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsParallel.mos" "Simulate and plot"),
