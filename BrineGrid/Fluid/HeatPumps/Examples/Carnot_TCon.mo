within BrineGrid.Fluid.HeatPumps.Examples;
model Carnot_TCon
 ...
 package Medium2 = BrineGrid.Media.Water "Medium model";
  ...
  BrineGrid.Fluid.HeatPumps.Carnot_TCon heaPum(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/Carnot_TCon.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
