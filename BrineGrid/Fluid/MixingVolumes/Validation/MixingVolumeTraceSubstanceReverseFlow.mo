...
model MixingVolumeTraceSubstanceReverseFlow
  ...
  extends
    BrineGrid.Fluid.MixingVolumes.Validation.BaseClasses.MixingVolumeReverseFlow(
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeTraceSubstanceReverseFlow.mos"
        "Simulate and plot"),
