within BrineGrid.Fluid.Actuators.Dampers;
model Exponential "Air damper with exponential opening characteristics"
  extends BrineGrid.Fluid.Actuators.BaseClasses.PartialDamperExponential(
...
protected
   ...
   parameter Real kThetaSqRt_default(min=0)=
     BrineGrid.Fluid.Actuators.BaseClasses.exponentialDamper(
       y=1,
       a=a,
       b=b,
       cL=cL,
...
BrineGrid.Fluid.Actuators.BaseClasses.exponentialDamper</a>.
</li>
<li>
June 10, 2008 by Michael Wetter:<br/>
Introduced new partial base class,
<a href=\"modelica://BrineGrid.Fluid.Actuators.BaseClasses.PartialDamperExponential\">
PartialDamperExponential</a>.
</li>
<li>
June 30, 2007 by Michael Wetter:<br/>
Introduced new partial base class,
<a href=\"modelica://BrineGrid.Fluid.Actuators.BaseClasses.PartialActuator\">PartialActuator</a>.
</li>
<li>
