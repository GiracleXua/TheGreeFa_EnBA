...
model CoolingAndHeating
  ...
  BrineGrid.Controls.Continuous.LimPID conHea(
    yMax=0.094,
    Td=0,
    reverseAction=false,
    Ti=100,
  ...
  BrineGrid.Controls.Continuous.LimPID conCoo(
    yMax=0.094,
    reverseAction=true,
    Td=0,
    k=0.5,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(StopTime=172800),__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingAndHeating.mos"
        "Simulate and plot"),
