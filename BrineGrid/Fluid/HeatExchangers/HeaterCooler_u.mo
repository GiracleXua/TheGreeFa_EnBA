...
model HeaterCooler_u "Heater or cooler with prescribed heat flow rate"
  extends BrineGrid.Fluid.Interfaces.TwoPortHeatMassExchanger(
    redeclare final BrineGrid.Fluid.MixingVolumes.MixingVolume vol(
...
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.HeaterCooler_T\">
...
the example
<a href=\"modelica://BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_u\">
BrineGrid.Fluid.HeatExchangers.Validation.HeaterCooler_u</a>.
</p>
</html>",
revisions="<html>
<ul>
