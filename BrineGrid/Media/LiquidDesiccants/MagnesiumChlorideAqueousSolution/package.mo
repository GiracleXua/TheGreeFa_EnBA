...
package MagnesiumChlorideAqueousSolution "H2O-MgCl2: Magnesium chloride aqueous solution (273 K ... 380 K, 0 wt-% ... 40 wt-%)"
  extends BrineGrid.Media.Examples.PartialGeneralBrineMedia(
    ...
    final mediumName="aqueous magnesium chloride solution",
    final substanceNames={"water", "magnesium chloride"},
...
aqueous solution (MgCl2-H2O) in the liquid region of 273 K to 380 K and from
0 wt-% to 40 wt-% MgCl2. </p>
...
<dl><dt>X. Xu, Y. Hu, L. Wu and S. Zhang:</dt>
<dd><b>Experimental and Modeling of Vapor-Liquid Equilibria for Electrolyte Solution Systems</b><br>
Journal of Chemical Engineering Data 59, p. 3741-3748 (2014)<br>
DOI: <a href=\"http://dx.doi.org/10.1021/je500623w\">10.1021/je500623w</a>
</dd></dl>
...
end MagnesiumChlorideAqueousSolution;
