within BrineGrid.Fluid.BaseClasses.FlowModels;
...
algorithm
  ...
  annotation(LateInline=true,
           ...
           derivative(order=1, zeroDerivative=k, zeroDerivative=m_flow_turbulent)=
             BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der,
           inverse(dp=BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
...
<code>BrineGrid.Fluid.FixedResistances.Validation.PressureDropsExplicit</code>
