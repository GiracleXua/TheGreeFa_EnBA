within BrineGrid.Fluid.FixedResistances;
model PressureDrop
  "Fixed flow resistance with dp and m_flow as parameter"
  extends BrineGrid.Fluid.BaseClasses.PartialResistance(
  ...
  if computeFlowResistance then
    if linearized then
      ...
      if homotopyInitialization then
        if from_dp then
          m_flow=homotopy(
            actual=BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
              dp=dp,
              k=k,
          ...
          dp=homotopy(
            actual=BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
              m_flow=m_flow,
              k=k,
              m_flow_turbulent=m_flow_turbulent),
        ...
        if from_dp then
          m_flow=BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
            dp=dp,
            k=k,
            m_flow_turbulent=m_flow_turbulent);
        else
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/FixedResistances/PressureDrop.png\"/>
</p>
...
<code>BrineGrid</code> library.
</p>
<p>
For a model that uses the hydraulic parameter and flow velocity at nominal conditions
as a parameter, use
<a href=\"modelica://BrineGrid.Fluid.FixedResistances.HydraulicDiameter\">
BrineGrid.Fluid.FixedResistances.HydraulicDiameter</a>.
</p>
<h4>Implementation</h4>
<p>
The pressure drop is computed by calling a function in the package
<a href=\"modelica://BrineGrid.Fluid.BaseClasses.FlowModels\">
BrineGrid.Fluid.BaseClasses.FlowModels</a>,
...
<a href=\"modelica://BrineGrid.Fluid.FixedResistances.Validation.PressureDropsExplicit\">
BrineGrid.Fluid.FixedResistances.Validation.PressureDropsExplicit</a>
remains the same.
</li>
<li>
...
<code>BrineGrid.Fluid.BaseClasses.PartialResistance</code>,
<code>BrineGrid.Fluid.Actuators.BaseClasses.PartialTwoWayValve</code>,
<code>BrineGrid.Fluid.Actuators.BaseClasses.PartialDamperExponential</code>,
<code>BrineGrid.Fluid.Actuators.BaseClasses.PartialActuator</code>
and model
<code>BrineGrid.Fluid.FixedResistances.PressureDrop</code>.
</li>
<li>
