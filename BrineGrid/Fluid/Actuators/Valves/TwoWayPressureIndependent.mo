...
equation
  ...
  dp_min = BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
              m_flow=m_flow_set,
              k=k,
 ...
 if (dpFixed_nominal > Modelica.Constants.eps) then
   ...
   if homotopyInitialization then
     if from_dp then
         m_flow=homotopy(actual=BrineGrid.Utilities.Math.Functions.regStep(
                            x=dp-dp_min,
                            y1= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            y2= BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
         ...
         dp=homotopy(actual=BrineGrid.Utilities.Math.Functions.regStep(
                            x=m_flow-m_flow_set,
                            y1= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            y2= BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
     ...
     if from_dp then
       m_flow=BrineGrid.Utilities.Math.Functions.regStep(
                            x=dp-dp_min,
                            y1= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            y2= BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
        ...
        dp=BrineGrid.Utilities.Math.Functions.regStep(
                            x=m_flow-m_flow_set,
                            y1= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            y2= BrineGrid.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
