within BrineGrid.Airflow.Multizone;
model MediumColumn
  ...
  parameter BrineGrid.Airflow.Multizone.Types.densitySelection densitySelection
...
initial equation
  ...
  assert(densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromTop
     or densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromBottom
     or densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.actual,
...
equation
  ...
  if (densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromTop) then
      Xi = inStream(port_a.Xi_outflow);
      rho = BrineGrid.Utilities.Psychrometrics.Functions.density_pTX(
        p=port_a.p,
        T=Medium.temperature(Medium.setState_phX(port_a.p, inStream(port_a.h_outflow), Xi)),
        X_w=if Medium.nXi == 0 then 0 else Xi[1]);
  elseif (densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromBottom) then
  ...
  annotation (
    Icon(graphics={
        ...
        Rectangle(
          visible=densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromTop,
          extent={{-16,80},{16,0}},
        ...
        Text(
          ...
          textString="%name"),
        Rectangle(
          visible=densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.actual,
          extent={{-16,80},{16,54}},
          fillColor={85,170,255},
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None,
          lineColor={0,0,0}),
        Rectangle(
          visible=densitySelection == BrineGrid.Airflow.Multizone.Types.densitySelection.fromBottom,
          extent={{-16,0},{16,-82}},
          fillColor={85,170,255},
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None,
...
<a href=\"modelica://BrineGrid.Airflow.Multizone.MediumColumnDynamic\">
BrineGrid.Airflow.Multizone.MediumColumnDynamic</a> instead of this model.
</p>
</html>",
revisions="<html>
<ul>
...
BrineGrid.Utilities.Psychrometrics.Functions.density_pTX</a>
for the density computation
as
<a href=\"modelica://BrineGrid.Media.Air.density\">
BrineGrid.Media.Air.density</a>
...
to address issue
<a href=\"https://github.com/lbl-srg/modelica-BrineGrid/issues/311\">#311</a>.
</li>
