...
model MassFraction "Test model for the mass fraction sensor"
  ...
  BrineGrid.Fluid.Sensors.MassFraction senMasFra2(
  ...
  BrineGrid.Fluid.Sensors.MassFractionTwoPort senMasFra1(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Sensors/Examples/MassFraction.mos"
        "Simulate and plot"),
