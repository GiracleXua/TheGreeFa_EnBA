...
equation
  x = time^3;
  y_comp=BrineGrid.Utilities.Math.Functions.smoothExponential(
                                               x=x, delta=delta);
  der(y)=der(y_comp);
  err = y_comp-y;
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothExponentialDerivativeCheck.mos"
        "Simulate and plot"),
