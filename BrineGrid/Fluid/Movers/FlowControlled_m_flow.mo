...
model FlowControlled_m_flow
  ...
  extends BrineGrid.Fluid.Movers.BaseClasses.PartialFlowMachine(
    final preVar=BrineGrid.Fluid.Movers.BaseClasses.Types.PrescribedVariable.FlowRate,
  ...
  Modelica.Blocks.Interfaces.RealInput m_flow_in(
    final unit="kg/s",
    nominal=m_flow_nominal) if inputType == BrineGrid.Fluid.Types.InputType.Continuous
...
<li>October 1, 2009
    by Michael Wetter:<br/>
       Model added to the BrineGrid library.
</ul>
</html>"),
    Icon(graphics={
        Text(
