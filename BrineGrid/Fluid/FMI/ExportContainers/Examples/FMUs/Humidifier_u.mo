...
block Humidifier_u
  "Declaration of an FMU that exports an ideal humidifier"
   extends BrineGrid.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final BrineGrid.Fluid.MassExchangers.Humidifier_u com(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/Humidifier_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
