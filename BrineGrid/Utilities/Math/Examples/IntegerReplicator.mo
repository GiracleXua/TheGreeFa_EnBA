...
model IntegerReplicator "Test model for integer replicator"
  ...
  BrineGrid.Utilities.Math.IntegerReplicator intRep(nout=
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegerReplicator.mos"
        "Simulate and plot"),
