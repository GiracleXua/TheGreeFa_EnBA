...
model Carnot_TEva_reverseFlow
 ...
 package Medium1 = BrineGrid.Media.Water "Medium model";
 package Medium2 = BrineGrid.Media.Water "Medium model";
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T sou1(nPorts=1,
  ...
  BrineGrid.Fluid.Sources.MassFlowSource_T sou2(nPorts=1,
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sin1(
    redeclare package Medium = Medium1,
    nPorts=1)
    annotation (Placement(
        ...
        extent={{10,-10},{-10,10}},
        origin={80,30})));
  BrineGrid.Fluid.Sources.FixedBoundary sin2(nPorts=1,
    redeclare package Medium = Medium2)
    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_reverseFlow.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
