...
package Medium = BrineGrid.Media.Air;
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source2(
    ...
    X={0.02,0.98})  annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        origin={38,70})));
  BrineGrid.Fluid.MassExchangers.ConstantEffectiveness masExcFor(
  ...
  BrineGrid.Fluid.MassExchangers.ConstantEffectiveness masExcRev(
    redeclare package Medium1 = Medium,
    redeclare package Medium2 = Medium,
    m1_flow_nominal=1,
    m2_flow_nominal=1,
  ...
  BrineGrid.Fluid.Sources.FixedBoundary sink2(
     redeclare package Medium = Medium,
     nPorts=2) "Fluid sink"
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source1(
    ...
    T(displayUnit="degC") = 293.15)
        ...
        extent={{-10,-10},{10,10}},
        origin={-150,100})));
  BrineGrid.Fluid.Sources.FixedBoundary sink1(
    redeclare package Medium = Medium,
    nPorts=2) "Fluid sink"
    annotation (Placement(
        transformation(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowMassExchanger.mos"
        "Simulate and plot"),
...
with
<code>BrineGrid.Fluid.Sources.FixedBoundary</code>
