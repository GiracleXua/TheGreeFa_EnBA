...
equation
  if approximateWetBulb then
    ...
    rh_per       = 100 * p/
         BrineGrid.Utilities.Psychrometrics.Functions.saturationPressure(TDryBul)
         *Xi[iWat]/(Xi[iWat] +
         BrineGrid.Utilities.Psychrometrics.Constants.k_mair*(1-Xi[iWat]));
    ...
    (TWetBul-BrineGrid.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * BrineGrid.Utilities.Psychrometrics.Constants.cpAir +
              XiSatRefIn * BrineGrid.Utilities.Psychrometrics.Constants.cpSte +
              (Xi[iWat]-XiSatRefIn) * BrineGrid.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-BrineGrid.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * BrineGrid.Utilities.Psychrometrics.Constants.cpAir +
              Xi[iWat] * BrineGrid.Utilities.Psychrometrics.Constants.cpSte)  +
    (Xi[iWat]-XiSatRefIn) * BrineGrid.Utilities.Psychrometrics.Constants.h_fg;
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
...
<a href=\"modelica://BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulPhi\">
BrineGrid.Utilities.Psychrometrics.TWetBul_TDryBulPhi</a>.
</p>
<h4>References</h4>
<p>
Stull, Roland.
...
<a href=\"modelica://BrineGrid.Utilities.Math.Functions.smoothMin\">
BrineGrid.Utilities.Math.Functions.smoothMin</a> rather
than <code>min</code>.
</li>
<li>
