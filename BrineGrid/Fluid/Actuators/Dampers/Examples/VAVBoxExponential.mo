within BrineGrid.Fluid.Actuators.Dampers.Examples;
model VAVBoxExponential
 ...
 package Medium = BrineGrid.Media.Air;
  ...
  BrineGrid.Fluid.Actuators.Dampers.Exponential dam(
  ...
  BrineGrid.Fluid.Actuators.Dampers.VAVBoxExponential vav(
...
equation
  ...
  connect(sin.ports[2], vav.port_b) annotation (Line(
      ...
      color={0,127,255}));
 annotation (             __Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/VAVBoxExponential.mos"
        "Simulate and plot"),
