...
model IncidenceAngle "Test model for incidence angle"
  ...
  BrineGrid.BoundaryConditions.SolarGeometry.BaseClasses.IncidenceAngle incAng(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/IncidenceAngle.mos"
        "Simulate and plot"));
end IncidenceAngle;
