...
model LimPIDWithReset
  ...
  Controller conWitRes(reset=BrineGrid.Types.Reset.Parameter)
  ...
  Controller conNoRes(reset=BrineGrid.Types.Reset.Disabled)
...
<p>
Plant model for
<a href=\"modelica://BrineGrid.Controls.Continuous.Examples.LimPIDWithReset\">
BrineGrid.Controls.Continuous.Examples.LimPIDWithReset</a>.
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPIDWithReset.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
