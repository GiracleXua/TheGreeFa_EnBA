...
model DirectTiltedSurface
  ...
  BrineGrid.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirRoo(
    til=BrineGrid.Types.Tilt.Ceiling,
    lat=0.6457718232379,
    azi=0.78539816339745) "Direct irradiation on roof"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  BrineGrid.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirFlo(
    til=BrineGrid.Types.Tilt.Floor,
    lat=0.6457718232379,
    azi=0.78539816339745) "Direct irradiation on floor"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  BrineGrid.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirWal(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/Examples/DirectTiltedSurface.mos"
        "Simulate and plot"),
