within BrineGrid.Utilities.Psychrometrics.Functions;
...
algorithm
  pSat := BrineGrid.Utilities.Math.Functions.regStep(
             y1=BrineGrid.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TSat),
             y2=BrineGrid.Utilities.Psychrometrics.Functions.sublimationPressureIce(TSat),
             x=TSat-273.16,
             x_small=1.0);
...
<a href=\"modelica://BrineGrid.Utilities.Math.Functions.spliceFunction\">
BrineGrid.Utilities.Math.Functions.spliceFunction</a> is only once
