within BrineGrid.Fluid.FMI.Conversion;
block InletToAir
  "Conversion from real signals for a fluid to a BrineGrid.Fluid.FMI.Interfaces.Inlet connector"
...
BrineGrid.Fluid.FMI.Interfaces.Inlet
</a>
and converts
