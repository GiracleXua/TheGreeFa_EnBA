...
model ThermalZone
  ...
  extends BrineGrid.Fluid.FMI.ExportContainers.ThermalZone(
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZone.mos"
        "Export FMU"));
end ThermalZone;
