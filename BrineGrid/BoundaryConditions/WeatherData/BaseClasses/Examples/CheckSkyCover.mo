...
model CheckSkyCover "Test model for checking sky cover"
  ...
  BrineGrid.BoundaryConditions.WeatherData.BaseClasses.CheckSkyCover
...
protected
  BrineGrid.Utilities.Time.ModelTime modTim "Generate simulation time"
...
__Dymola_Commands(file="modelica://BrineGrid/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckSkyCover.mos"
        "Simulate and plot"));
end CheckSkyCover;
