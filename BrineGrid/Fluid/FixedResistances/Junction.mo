...
model Junction
  "Flow splitter with fixed resistance at each port"
    extends BrineGrid.Fluid.BaseClasses.PartialThreeWayResistance(
    mDyn_flow_nominal = sum(abs(m_flow_nominal[:])/3),
    redeclare BrineGrid.Fluid.FixedResistances.PressureDrop res1(
      ...
      deltaM=deltaM),
    redeclare BrineGrid.Fluid.FixedResistances.PressureDrop res2(
      final allowFlowReversal=true,
      from_dp=from_dp,
      ...
      homotopyInitialization=homotopyInitialization,
      deltaM=deltaM),
    redeclare BrineGrid.Fluid.FixedResistances.PressureDrop res3(
      final allowFlowReversal=true,
      from_dp=from_dp,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BrineGrid/Resources/Images/Fluid/FixedResistances/Junction.png\"/>
</p>
<p>
If
...
<a href=\"modelica://BrineGrid.Fluid.Delays.DelayFirstOrder\">
BrineGrid.Fluid.Delays.DelayFirstOrder</a>.
...
Based class on
<a href=\"modelica://BrineGrid.Fluid.BaseClasses.PartialThreeWayFixedResistance\">
