within BrineGrid.Fluid.Examples.FlowSystem;
model Basic "Example implementation of flow system"
  extends Modelica.Icons.Example;
  package Medium = BrineGrid.Media.Water "Medium model";
  BrineGrid.Fluid.Movers.FlowControlled_dp pmpSouth(
    redeclare package Medium = Medium,
    redeclare replaceable
      BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    m_flow_nominal=27570/3600,
    inputType=BrineGrid.Fluid.Types.InputType.Stages,
    ...
    "Pump to south of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-60,-20})));
  BrineGrid.Fluid.FixedResistances.PressureDrop pipSouth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,18})));
  BrineGrid.Fluid.FixedResistances.PressureDrop pipSouth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=3) "Pipe 2 to south of building" annotation (Placement(
        ...
        rotation=90,
        origin={-40,18})));
  BrineGrid.Fluid.Movers.FlowControlled_dp pmpNorth(
    redeclare package Medium = Medium,
    redeclare replaceable
      BrineGrid.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    "Pump to north of building"  annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={60,-20})));
  BrineGrid.Fluid.FixedResistances.PressureDrop pipNorth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=5) "Pipe 2 to north of building" annotation (Placement(
        ...
        rotation=90,
        origin={80,18})));
  BrineGrid.Fluid.FixedResistances.PressureDrop pipNorth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,18})));
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear[4] valSouth1(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-80,60})));
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear[8] valSouth2(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=270,
        origin={-40,60})));
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear[4] valNorth1(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={40,60})));
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear[8] valNorth2(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
  ...
  BrineGrid.Fluid.Actuators.Valves.ThreeWayLinear valSouth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-50})));
  BrineGrid.Fluid.Actuators.Valves.ThreeWayLinear valNorth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dpFixed_nominal={20000,0},
    from_dp=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={60,-50})));
  BrineGrid.Fluid.HeatExchangers.HeaterCooler_T heater(
    m_flow_nominal=10,
    dp_nominal=100,
    redeclare package Medium = Medium) "Heating device"
    annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
  BrineGrid.Fluid.Sources.Boundary_pT bou(nPorts=1,
  redeclare package Medium = Medium)
    "Boundary for setting absolute temperature"
    annotation (Placement(transformation(extent={{-100,-140},{-80,-120}})));
  BrineGrid.Fluid.FixedResistances.Junction spl(
  ...
  BrineGrid.Fluid.FixedResistances.Junction spl1(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Splitter"
    annotation (Placement(transformation(extent={{-20,-120},{-40,-140}})));
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumpHea(
    m_flow_nominal=10,
    redeclare BrineGrid.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2 per,
    redeclare package Medium = Medium,
    inputType=BrineGrid.Fluid.Types.InputType.Stages,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear valHea(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    redeclare package Medium = Medium,
  ...
  BrineGrid.Fluid.Actuators.Valves.TwoWayLinear valCoo(
    each dpFixed_nominal=0,
    each CvData=BrineGrid.Fluid.Types.CvTypes.OpPoint,
    redeclare package Medium = Medium,
    each m_flow_nominal=10,
  ...
  BrineGrid.Fluid.FixedResistances.Junction spl2(
    m_flow_nominal={10,10,10},
    dp_nominal={1000,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Splitter"
    annotation (Placement(transformation(extent={{40,-110},{20,-90}})));
  BrineGrid.Fluid.FixedResistances.Junction spl3(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Splitter"
    annotation (Placement(transformation(extent={{20,-120},{40,-140}})));
  BrineGrid.Fluid.Movers.FlowControlled_m_flow pumpCoo(
    m_flow_nominal=10,
    redeclare
      BrineGrid.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2
      per,
    redeclare package Medium = Medium,
    inputType=BrineGrid.Fluid.Types.InputType.Stages,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  BrineGrid.Fluid.MixingVolumes.MixingVolume vol(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=10,
  ...
  BrineGrid.Fluid.FixedResistances.PressureDrop tabsSouth1[4](
    redeclare each package Medium = Medium,
    ...
    "Pressure drop of southern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-80,90})));
  BrineGrid.Fluid.FixedResistances.PressureDrop tabsSouth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of southern tabs sections on collector 2" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-40,90})));
  BrineGrid.Fluid.FixedResistances.PressureDrop tabsNorth1[4](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of northern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={40,90})));
  BrineGrid.Fluid.FixedResistances.PressureDrop tabsNorth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
...
<p>
Example model demonstrating the use of the <code>BrineGrid</code> components in a larger system. 
This model is extended in
<a href=\"modelica://BrineGrid.Fluid.Examples.FlowSystem.Simplified1\">
BrineGrid.Fluid.Examples.FlowSystem.Simplified1</a>,
<a href=\"modelica://BrineGrid.Fluid.Examples.FlowSystem.Simplified2\">
BrineGrid.Fluid.Examples.FlowSystem.Simplified2</a>,
<a href=\"modelica://BrineGrid.Fluid.Examples.FlowSystem.Simplified3\">
BrineGrid.Fluid.Examples.FlowSystem.Simplified3</a>.
